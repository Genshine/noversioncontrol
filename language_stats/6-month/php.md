...
| 2. | [helloqingfeng/Awsome-Front-End-learning-resource](https://github.com/helloqingfeng/Awsome-Front-End-learning-resource) <br/>:octocat:GitHub最全的前端资源汇总仓库（包括前端学习、开发资源、求职面试等） | 1717 |
| 3. | [SimpleRegex/SRL-PHP](https://github.com/SimpleRegex/SRL-PHP) <br/>Simple Regex Language | 1633 |
| 4. | [renatomarinho/laravel-gitscrum](https://github.com/renatomarinho/laravel-gitscrum) <br/>Laravel GitScrum is a free application to task man... | 1186 |
| 5. | [mpociot/botman](https://github.com/mpociot/botman) <br/>A framework agnostic PHP library to build chat bot... | 1129 |
| 6. | [Vuedo/vuedo](https://github.com/Vuedo/vuedo) <br/>Vuedo is a blog platform, built with Laravel and V... | 899 |
| 7. | [summerblue/phphub5](https://github.com/summerblue/phphub5) <br/>PHPHub Ver 5 is a Forum project Powered by Laravel... | 781 |
| 8. | [rinvex/country](https://github.com/rinvex/country) <br/>Rinvex Country is a simple and lightweight package... | 705 |
| 9. | [ngfw/Recipe](https://github.com/ngfw/Recipe) <br/>Collection of PHP Functions | 625 |
| 10. | [orangetw/My-CTF-Web-Challenges](https://github.com/orangetw/My-CTF-Web-Challenges) <br/>Collection of CTF Web challenges I made | 620 |
| 11. | [Leafpub/leafpub](https://github.com/Leafpub/leafpub) <br/>Simple, beautiful, open source publishing. | 605 |
| 12. | [etsy/411](https://github.com/etsy/411) <br/>An Alert Management Web Application | 584 |
| 13. | [WhiteHouse/fb_messenger_bot](https://github.com/WhiteHouse/fb_messenger_bot) <br/>This Drupal module provides a tool to build a chat... | 522 |
| 14. | [lufficc/Xblog](https://github.com/lufficc/Xblog) <br/>A powerful and responsive blog system powered by l... | 486 |
| 15. | [TIGERB/easy-tips](https://github.com/TIGERB/easy-tips) <br/>a little tips in my code career | 477 |
| 16. | [cviebrock/sequel-pro-laravel-export](https://github.com/cviebrock/sequel-pro-laravel-export) <br/>A Sequel Pro bundle to generate Laravel migration ... | 428 |
| 17. | [spatie/regex](https://github.com/spatie/regex) <br/>A sane interface for php's built in preg_* functio... | 396 |
| 18. | [jcc/blog](https://github.com/jcc/blog) <br/>:heart: PJ Blog is an open source blog built with ... | 374 |
| 19. | [laravel/passport](https://github.com/laravel/passport)  | 361 |
| 20. | [codecasts/spa-starter-kit](https://github.com/codecasts/spa-starter-kit) <br/>A highly opinionated starter kit for building Sing... | 320 |
| 21. | [ijry/lyadmin](https://github.com/ijry/lyadmin) <br/>lyadmin是一套轻量级通用后台，采用Bootstrap3制作，自带权限管理，模块化开发。 | 302 |
| 22. | [unicodeveloper/laravel-password](https://github.com/unicodeveloper/laravel-password) <br/>:closed_lock_with_key: :smiling_imp: Guard your us... | 297 |
| 23. | [Tencent/bk-cmdb](https://github.com/Tencent/bk-cmdb) <br/>蓝鲸智云配置平台(blueking cmdb) | 283 |
| 24. | [spatie/opening-hours](https://github.com/spatie/opening-hours) <br/>Query and format a set of opening hours | 281 |
| 25. | [zqqian/baidulixiandown](https://github.com/zqqian/baidulixiandown) <br/>HIGHER SPEED TO DOWNLOAD BAIDU NET DISK | 273 |
| 26. | [kaienkira/acme-client-quick](https://github.com/kaienkira/acme-client-quick) <br/>Get Let's Encrypt Cert In Five Minutes | 270 |
| 27. | [EasyCorp/easy-log-handler](https://github.com/EasyCorp/easy-log-handler) <br/>Human-friendly log files that make you more produc... | 268 |
| 28. | [adamwathan/blade-svg](https://github.com/adamwathan/blade-svg)  | 263 |
| 29. | [summerblue/laravel-package-top-100](https://github.com/summerblue/laravel-package-top-100) <br/>对 Packagist 上打了 Laravel 标签 的扩展包进行整理，截止到现在 2016 年 8... | 259 |
| 30. | [EleTeam/Shop-PHP-Yii2](https://github.com/EleTeam/Shop-PHP-Yii2) <br/>EleTeam开源项目-电商全套解决方案之PHP版-Shop-for-PHP-Yii2。一个类似京东... | 258 |
| 31. | [wells/airflix](https://github.com/wells/airflix) <br/>🍿 An AirPlay friendly web interface to stream your... | 252 |
| 32. | [plank/laravel-mediable](https://github.com/plank/laravel-mediable) <br/>Laravel-Mediable is a package for easily uploading... | 251 |
| 33. | [CityOfBoston/boston.gov](https://github.com/CityOfBoston/boston.gov) <br/>The official repository of Boston.gov | 247 |
