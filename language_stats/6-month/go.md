...
| | Repo | Stars |
|---|---|---|
| 1. | [fogleman/primitive](https://github.com/fogleman/primitive) <br/>Reproducing images with geometric primitives. | 5648 |
| 2. | [alexflint/gallium](https://github.com/alexflint/gallium) <br/>Build desktop applications in Go and HTML. | 2990 |
| 3. | [davecheney/httpstat](https://github.com/davecheney/httpstat) <br/>It's like curl -v, with colours. | 2733 |
| 4. | [sourcegraph/thyme](https://github.com/sourcegraph/thyme) <br/>Automatically track which applications you use and... | 1786 |
| 5. | [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) <br/>Chaos Monkey is a resiliency tool that helps appli... | 1676 |
| 6. | [anthonynsimon/bild](https://github.com/anthonynsimon/bild) <br/>A collection of parallel image processing algorith... | 1340 |
| 7. | [tidwall/buntdb](https://github.com/tidwall/buntdb) <br/>BuntDB is a fast, embeddable, in-memory key/value ... | 1315 |
| 8. | [iamduo/workq](https://github.com/iamduo/workq) <br/>Job server in Go | 1242 |
| 9. | [gravitational/teleconsole](https://github.com/gravitational/teleconsole) <br/>Command line tool to share your UNIX terminal and ... | 1225 |
| 10. | [google/gops](https://github.com/google/gops) <br/>A tool to list and diagnose Go processes currently... | 1170 |
| 11. | [tockins/realize](https://github.com/tockins/realize) <br/>Go build system with file watchers, live reload an... | 1008 |
| 12. | [ok-borg/borg](https://github.com/ok-borg/borg) <br/>Search and save shell snippets without leaving you... | 978 |
| 13. | [google/netstack](https://github.com/google/netstack) <br/>IPv4 and IPv6 userland network stack | 925 |
| 14. | [tidwall/gjson](https://github.com/tidwall/gjson) <br/>Get JSON values very quickly in Go | 866 |
| 15. | [shiyanhui/dht](https://github.com/shiyanhui/dht) <br/>BitTorrent DHT Protocol && DHT Spider | 813 |
| 16. | [natefinch/gorram](https://github.com/natefinch/gorram) <br/>It's like go run for any go function | 775 |
| 17. | [chewxy/gorgonia](https://github.com/chewxy/gorgonia) <br/>Gorgonia is a library that helps facilitate machin... | 758 |
| 18. | [rook/rook](https://github.com/rook/rook) <br/>Open, Cloud Native, and Universal Distributed Stor... | 751 |
| 19. | [tidwall/summitdb](https://github.com/tidwall/summitdb) <br/>In-memory NoSQL database with ACID transactions, R... | 742 |
| 20. | [jaksi/sshesame](https://github.com/jaksi/sshesame) <br/>A fake SSH server that lets everyone in and logs t... | 721 |
| 21. | [tidwall/redcon](https://github.com/tidwall/redcon) <br/>Fast Redis compatible server framework for Go | 720 |
| 22. | [chain/chain](https://github.com/chain/chain) <br/>Chain Core Developer Edition | 705 |
| 23. | [puma/puma-dev](https://github.com/puma/puma-dev) <br/>A tool to manage rack apps in development with pum... | 697 |
| 24. | [jpmorganchase/quorum](https://github.com/jpmorganchase/quorum) <br/>A permissioned implementation of Ethereum supporti... | 665 |
| 25. | [slackhq/go-audit](https://github.com/slackhq/go-audit) <br/>go-audit is an alternative to the auditd daemon th... | 629 |
| 26. | [wcharczuk/go-chart](https://github.com/wcharczuk/go-chart) <br/>go chart is a basic charting library in native gol... | 629 |
| 27. | [GoASTScanner/gas](https://github.com/GoASTScanner/gas) <br/>Go AST Scanner | 617 |
| 28. | [go-gitea/gitea](https://github.com/go-gitea/gitea) <br/>Gitea: Git with a cup of tea | 617 |
| 29. | [blox/blox](https://github.com/blox/blox) <br/>Open source tools for building custom schedulers o... | 610 |
| 30. | [rakyll/hey](https://github.com/rakyll/hey) <br/>HTTP load generator, ApacheBench (ab) replacement,... | 608 |
| 31. | [oklog/ulid](https://github.com/oklog/ulid) <br/>Universally Unique Lexicographically Sortable Iden... | 600 |
| 32. | [irfansharif/cfilter](https://github.com/irfansharif/cfilter) <br/>Cuckoo Filter implementation in Go, better than Bl... | 587 |
| 33. | [Dataman-Cloud/crane](https://github.com/Dataman-Cloud/crane) <br/>Yet another control plane based on docker built-in... | 583 |
