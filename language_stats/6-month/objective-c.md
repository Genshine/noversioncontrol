...
| | Repo | Stars |
|---|---|---|
| 1. | [Kapeli/Dash-iOS](https://github.com/Kapeli/Dash-iOS) <br/>Dash gives your iPad and iPhone instant offline ac... | 5170 |
| 2. | [Jasonette/JASONETTE-iOS](https://github.com/Jasonette/JASONETTE-iOS) <br/>📡 Native App over HTTP, on iOS | 3798 |
| 3. | [Instagram/IGListKit](https://github.com/Instagram/IGListKit) <br/>A data-driven UICollectionView framework for build... | 3528 |
| 4. | [SunLiner/MiaowShow](https://github.com/SunLiner/MiaowShow) <br/>iOS视频直播项目 | 1861 |
| 5. | [anishathalye/lumen](https://github.com/anishathalye/lumen) <br/>Magic auto brightness based on screen contents :bu... | 1838 |
| 6. | [wireapp/wire-ios](https://github.com/wireapp/wire-ios) <br/>📱 Wire iOS client (iPhone and iPad) | 1707 |
| 7. | [wg689/Solve-App-Store-Review-Problem](https://github.com/wg689/Solve-App-Store-Review-Problem) <br/>a collection   to solve app store review problem (... | 1650 |
| 8. | [MichaelHuyp/Bilibili_Wuxianda](https://github.com/MichaelHuyp/Bilibili_Wuxianda) <br/>高仿Bilibili客户端 - ( ゜- ゜)つロ 乾杯~ | 1515 |
| 9. | [bikkelbroeders/TouchBarDemoApp](https://github.com/bikkelbroeders/TouchBarDemoApp) <br/>Allows you to use your macOS Touch Bar from an iPa... | 1481 |
| 10. | [spotify/HubFramework](https://github.com/spotify/HubFramework) <br/>Spotify’s component-driven UI framework for iOS | 1371 |
| 11. | [iphone5solo/PYSearch](https://github.com/iphone5solo/PYSearch) <br/>🔍 An elegant search controller which replaces the ... | 1358 |
| 12. | [alibaba/BeeHive](https://github.com/alibaba/BeeHive) <br/>:honeybee: BeeHive is a solution for iOS Applicati... | 1344 |
| 13. | [GrayJIAXU/520Linkee](https://github.com/GrayJIAXU/520Linkee) <br/>本项目实现了作为一个直播App的基本功能，比如本地视频流采集、播放、美颜、礼物、点赞出心等。 | 1313 |
| 14. | [Automattic/simplenote-ios](https://github.com/Automattic/simplenote-ios) <br/>Simplenote for iOS | 1298 |
| 15. | [nacker/LZEasemob3](https://github.com/nacker/LZEasemob3) <br/>酷信 | 高仿微信| WeChat | 高仿朋友圈 | moments| Github上最牛逼的高仿... | 1108 |
| 16. | [Nicejinux/NXDrawKit](https://github.com/Nicejinux/NXDrawKit) <br/>NXDrawKit is a simple and easy but useful drawing ... | 877 |
| 17. | [Charlesyaoxin/NeiHanDuanZI](https://github.com/Charlesyaoxin/NeiHanDuanZI) <br/>内涵段子 | 741 |
| 18. | [crazycodeboy/RNStudyNotes](https://github.com/crazycodeboy/RNStudyNotes) <br/>React Native 研究与实践 | 696 |
| 19. | [gyjzh/LLWeChat](https://github.com/gyjzh/LLWeChat) <br/>实现IM基本功能，并且在细节、完成度、bugfree上媲美任何主流IM应用 | 690 |
| 20. | [istornz/iPokeGo](https://github.com/istornz/iPokeGo) <br/>A native iOS client to map the Pokemon around you! | 658 |
| 21. | [cyanzhong/Retriever](https://github.com/cyanzhong/Retriever) <br/>Retrieving InfoPlist without Jailbreaking on iOS D... | 635 |
| 22. | [ptmt/react-native-touchbar](https://github.com/ptmt/react-native-touchbar) <br/>TouchBar for react-native-macos | 617 |
| 23. | [QMUI/QMUI_iOS](https://github.com/QMUI/QMUI_iOS) <br/>QMUI iOS——致力于提高项目 UI 开发效率的解决方案 | 614 |
| 24. | [Jinxiansen/JHUD](https://github.com/Jinxiansen/JHUD) <br/>A full screen of the HUD when loading the data (Ob... | 607 |
| 25. | [Automattic/simplenote-macos](https://github.com/Automattic/simplenote-macos) <br/>Simplenote for macOS | 589 |
| 26. | [insidegui/AppleEvents](https://github.com/insidegui/AppleEvents) <br/>The unofficial Apple Events app for macOS | 554 |
| 27. | [yahoo/YangMingShan](https://github.com/yahoo/YangMingShan) <br/>YangMingShan is a collection of iOS UI components ... | 539 |
| 28. | [exponent/exponent](https://github.com/exponent/exponent) <br/>Exponent iOS/Android Client | 529 |
| 29. | [nimati/FCAlertView](https://github.com/nimati/FCAlertView) <br/>FCAlertView is a Flat Customizable AlertView for i... | 475 |
| 30. | [googlecreativelab/Sprayscape](https://github.com/googlecreativelab/Sprayscape) <br/>Sprayscape is a perfectly imperfect VR-ish camera.... | 460 |
| 31. | [kangzubin/XMNetworking](https://github.com/kangzubin/XMNetworking) <br/>A lightweight but powerful network library with si... | 436 |
| 32. | [liuzhiyi1992/ZYSideSlipFilter](https://github.com/liuzhiyi1992/ZYSideSlipFilter) <br/>Awesome side slip filter for your display rack, 侧边... | 373 |
| 33. | [Josin22/JSDownloadView](https://github.com/Josin22/JSDownloadView) <br/>精巧顺滑的下载动画 | 370 |
...
| 35. | [qasim](https://github.com/qasim)  | [Airstream](https://github.com/qasim/Airstream)  (274) <br/> | 274 |
...
| 72. | [weijentu](https://github.com/weijentu)  | [automatic-height-tagcells](https://github.com/weijentu/automatic-height-tagcells)  (149) <br/> | 149 |
...
| 109. | [LinXunFeng](https://github.com/LinXunFeng)  | [LXFFM](https://github.com/LinXunFeng/LXFFM)  (104) <br/> | 104 |
