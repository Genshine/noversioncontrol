...
| | Repo | Stars |
|---|---|---|
| 1. | [open-guides/og-aws](https://github.com/open-guides/og-aws) <br/>📙 Amazon Web Services — a practical guide | 15436 |
| 2. | [rgcr/m-cli](https://github.com/rgcr/m-cli) <br/> Swiss Army Knife for macOS | 5425 |
| 3. | [warpling/Macmoji](https://github.com/warpling/Macmoji) <br/>Slack/GitHub/Trello emoji for your mac! 😁 💥 💻 | 1070 |
| 4. | [mchav/with](https://github.com/mchav/with) <br/>Command prefixing for continuous workflow using a ... | 1056 |
| 5. | [google/oss-fuzz](https://github.com/google/oss-fuzz) <br/>OSS-Fuzz - continuous fuzzing of open source softw... | 975 |
| 6. | [adtac/climate](https://github.com/adtac/climate) <br/>The ultimate command line tool for Linux developer... | 967 |
| 7. | [Coding/WebIDE](https://github.com/Coding/WebIDE) <br/>Coding WebIDE Community Edition | 509 |
| 8. | [gfredericks/quinedb](https://github.com/gfredericks/quinedb) <br/>QuineDB is a quine that is also a key-value store. | 499 |
| 9. | [paulirish/git-recent](https://github.com/paulirish/git-recent) <br/>See your latest local git branches, formatted real... | 495 |
| 10. | [Screetsec/Dracnmap](https://github.com/Screetsec/Dracnmap) <br/>Dracnmap is an open source program which is using ... | 452 |
| 11. | [pimterry/notes](https://github.com/pimterry/notes) <br/>:pencil: Simple delightful note taking, with more ... | 385 |
| 12. | [kovetskiy/go-fast](https://github.com/kovetskiy/go-fast) <br/>Compile Go programs 7x faster | 375 |
| 13. | [gojuno/mainframer](https://github.com/gojuno/mainframer) <br/>Pretty universal instruction and script to setup R... | 333 |
| 14. | [plexinc/pms-docker](https://github.com/plexinc/pms-docker) <br/>Plex Media Server Docker repo, for all your PMS do... | 294 |
| 15. | [haoel/haoel.github.io](https://github.com/haoel/haoel.github.io)  | 278 |
| 16. | [mars/create-react-app-buildpack](https://github.com/mars/create-react-app-buildpack) <br/>Heroku Buildpack for create-react-app: static host... | 277 |
| 17. | [octoai/octo.ai](https://github.com/octoai/octo.ai) <br/>The analytics hypervisor, an operating system to m... | 263 |
| 18. | [SafeBreach-Labs/pwndsh](https://github.com/SafeBreach-Labs/pwndsh) <br/>Post-exploitation framework (and an interactive sh... | 253 |
| 19. | [MakeNowJust/bashcached](https://github.com/MakeNowJust/bashcached) <br/>memcached built on bash + socat | 251 |
| 20. | [pimterry/git-confirm](https://github.com/pimterry/git-confirm) <br/>:question: Git hook to catch placeholders and temp... | 235 |
| 21. | [ncuillery/rn-diff](https://github.com/ncuillery/rn-diff) <br/>Easier React Native upgrades by clearly expose cha... | 218 |
| 22. | [MariusQuabeck/magic-device-tool](https://github.com/MariusQuabeck/magic-device-tool) <br/>A simple and feature full batch tool to handle ins... | 217 |
| 23. | [felixSchl/git-fiddle](https://github.com/felixSchl/git-fiddle) <br/>Edit commit messages, authors and timestamps durin... | 202 |
| 24. | [CyberShadow/aconfmgr](https://github.com/CyberShadow/aconfmgr) <br/>A configuration manager for Arch Linux | 177 |
| 25. | [thomaspaulmann/Swish](https://github.com/thomaspaulmann/Swish) <br/>👷Build Swift Projects on a Remote Machine within X... | 170 |
| 26. | [tiaanduplessis/awesome-react-native-talks](https://github.com/tiaanduplessis/awesome-react-native-talks) <br/>:sunglasses: A curated list of talks about React N... | 159 |
| 27. | [tightenco/lambo](https://github.com/tightenco/lambo) <br/>Quick new application creation with Laravel and Va... | 147 |
| 28. | [sroberts/awesome-iocs](https://github.com/sroberts/awesome-iocs) <br/>A collection of sources of indicators of compromis... | 146 |
| 29. | [shadowsocks/luci-app-shadowsocks](https://github.com/shadowsocks/luci-app-shadowsocks) <br/>OpenWrt LuCI for Shadowsocks-libev | 139 |
| 30. | [chenglou/intro-to-reason-compilation](https://github.com/chenglou/intro-to-reason-compilation) <br/>Ready up! | 138 |
| 31. | [Cyclenerd/gallery_shell](https://github.com/Cyclenerd/gallery_shell) <br/>📷 Bash Script to generate static responsive image ... | 136 |
| 32. | [dkalaitzidis/SwiftyAvatar](https://github.com/dkalaitzidis/SwiftyAvatar) <br/>iOS Swift class to create circular or rounded avat... | 135 |
| 33. | [xtiankisutsa/MARA_Framework](https://github.com/xtiankisutsa/MARA_Framework) <br/>MARA is a Mobile Application Reverse engineering a... | 132 |
