...
| | Repo | Stars |
|---|---|---|
| 1. | [kickstarter/ios-oss](https://github.com/kickstarter/ios-oss) <br/>Kickstarter for iOS. Bring new ideas to life, anyw... | 3635 |
| 2. | [shu223/iOS-10-Sampler](https://github.com/shu223/iOS-10-Sampler) <br/>Code examples for new APIs of iOS 10. | 2691 |
| 3. | [kahopoon/Pokemon-Go-Controller](https://github.com/kahopoon/Pokemon-Go-Controller) <br/>play pokemon go safely or at unavailable area | 2504 |
| 4. | [omaralbeik/SwifterSwift](https://github.com/omaralbeik/SwifterSwift) <br/>A handy collection of more than 390 native Swift 3... | 2373 |
| 5. | [avatsaev/touchbar_nyancat](https://github.com/avatsaev/touchbar_nyancat) <br/>Stupid nyancat animation on your +$2k MacBook Pro'... | 1967 |
| 6. | [BeauNouvelle/FaceAware](https://github.com/BeauNouvelle/FaceAware) <br/>An extension that gives UIImageView the ability to... | 1720 |
| 7. | [eBay/NMessenger](https://github.com/eBay/NMessenger) <br/>A fast, lightweight messenger component built on A... | 1695 |
| 8. | [SwiftKickMobile/SwiftMessages](https://github.com/SwiftKickMobile/SwiftMessages) <br/>A very flexible message bar for iOS written in Swi... | 1682 |
| 9. | [ltebean/Live](https://github.com/ltebean/Live) <br/>Demonstrate how to build a live broadcast app(Swif... | 1479 |
| 10. | [Cosmo/TinyConsole](https://github.com/Cosmo/TinyConsole) <br/>🚦📱 A tiny log console to display information while... | 1464 |
| 11. | [BendingSpoons/katana-swift](https://github.com/BendingSpoons/katana-swift) <br/>Swift Apps in a Swoosh! A modern framework for cre... | 1343 |
| 12. | [krzysztofzablocki/Sourcery](https://github.com/krzysztofzablocki/Sourcery) <br/>A tool that brings meta-programming to Swift, allo... | 1302 |
| 13. | [zhuhaow/SpechtLite](https://github.com/zhuhaow/SpechtLite) <br/>A rule-based proxy for macOS | 1253 |
| 14. | [nicklockwood/SwiftFormat](https://github.com/nicklockwood/SwiftFormat) <br/>A code library and command-line formatting tool fo... | 1092 |
| 15. | [SebastianBoldt/Jelly](https://github.com/SebastianBoldt/Jelly) <br/>💪 Jelly provides custom view controller transition... | 1088 |
| 16. | [146BC/StyleKit](https://github.com/146BC/StyleKit) <br/>A powerful & easy to use styling framework written... | 1042 |
| 17. | [aslanyanhaik/youtube-iOS](https://github.com/aslanyanhaik/youtube-iOS) <br/>youtube iOS app template written in swift 3 | 1042 |
| 18. | [marciok/Mu](https://github.com/marciok/Mu) <br/>It's a Swift playground explaining how to create a... | 1032 |
| 19. | [Yalantis/Segmentio](https://github.com/Yalantis/Segmentio) <br/>Animated top/bottom segmented control written in S... | 1018 |
| 20. | [facebook/facebook-sdk-swift](https://github.com/facebook/facebook-sdk-swift) <br/>Integrate your iOS apps in Swift with Facebook Pla... | 965 |
| 21. | [itsmeichigo/DateTimePicker](https://github.com/itsmeichigo/DateTimePicker) <br/>A nicer iOS UI component for picking date and time | 885 |
| 22. | [orazz/CreditCardForm-iOS](https://github.com/orazz/CreditCardForm-iOS) <br/>CreditCardForm is iOS framework that allows develo... | 833 |
| 23. | [Yalantis/ColorMatchTabs](https://github.com/Yalantis/ColorMatchTabs) <br/>This is a Review posting app that let user find in... | 750 |
| 24. | [naru-jpn/View2ViewTransition](https://github.com/naru-jpn/View2ViewTransition) <br/>Custom interactive view controller transition from... | 728 |
| 25. | [kyleduo/TinyPNG4Mac](https://github.com/kyleduo/TinyPNG4Mac) <br/>TinyPNG client for Mac | 721 |
| 26. | [mcmatan/ImageOpenTransition](https://github.com/mcmatan/ImageOpenTransition) <br/>Beautiful and precise transitions between ViewCont... | 719 |
| 27. | [Yalantis/PixPic](https://github.com/Yalantis/PixPic) <br/>PixPic, a Photo Editing App | 717 |
| 28. | [onmyway133/Snowflake](https://github.com/onmyway133/Snowflake) <br/>❄️  SVG in Swift | 711 |
| 29. | [totocaster/Typist](https://github.com/totocaster/Typist) <br/>Small Swift UIKit keyboard manager for iOS apps. | 711 |
| 30. | [mariohahn/StatusProvider](https://github.com/mariohahn/StatusProvider) <br/>Protocol to handle initial Loadings, Empty Views a... | 708 |
| 31. | [krzysztofzablocki/KZFileWatchers](https://github.com/krzysztofzablocki/KZFileWatchers) <br/>A micro-framework for observing file changes, both... | 702 |
| 32. | [dalu93/Each](https://github.com/dalu93/Each) <br/>Elegant ⏱ interface for Swift apps | 698 |
| 33. | [edopelawi/CascadingTableDelegate](https://github.com/edopelawi/CascadingTableDelegate) <br/>A no-nonsense way to write cleaner UITableViewDele... | 679 |
| 34. | [apple/swift-protobuf](https://github.com/apple/swift-protobuf) <br/>Plugin and runtime library for using protobuf with... | 669 |
...
| 71. | [hrscy/DanTang](https://github.com/hrscy/DanTang) <br/>Swift开源项目-模仿单糖 | 368 |
...
| 108. | [toolinbox/iPicUploader](https://github.com/toolinbox/iPicUploader) <br/>Use iPic to upload images on macOS. | 235 |
...
| 92. | [OrRon](https://github.com/OrRon)  | [ConfettiView](https://github.com/OrRon/ConfettiView)  (199) <br/> | 199 |
...
| 129. | [victorBaro](https://github.com/victorBaro)  | [AlgoGraphics](https://github.com/victorBaro/AlgoGraphics)  (119) <br/> | 119 |
...
| 18. | [MDCC2016](https://github.com/MDCC2016)  | [ProtocolNetwork](https://github.com/MDCC2016/ProtocolNetwork)  (356) <br/> | 356 |
...
| Go | [Repos](https://github.com/donnemartin/gh-stats/blob/master/language_stats/2016/go.md#most-starred-repos-go) - [Users](https://github.com/donnemartin/gh-stats/blob/master/language_stats/2016/go.md#most-starred-users-go) - [Orgs](https://github.com/donnemartin/gh-stats/blob/master/language_stats/2016/go.md#most-