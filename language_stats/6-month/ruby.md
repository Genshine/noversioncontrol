...
| | Repo | Stars |
|---|---|---|
| 1. | [roberdam/Xaddress](https://github.com/roberdam/Xaddress) <br/>Xaddress - Give 7 billion people an instant physic... | 1189 |
| 2. | [octobox/octobox](https://github.com/octobox/octobox) <br/>:postbox: Take back control of your GitHub Notific... | 1148 |
| 3. | [testdouble/suture](https://github.com/testdouble/suture) <br/>🏥 A Ruby gem that helps you refactor your legacy c... | 782 |
| 4. | [rails/webpacker](https://github.com/rails/webpacker) <br/>Use Webpack to manage app-like JavaScript modules ... | 644 |
| 5. | [heckpsi-lab/em-midori](https://github.com/heckpsi-lab/em-midori) <br/>Lightweight, Flexible and Fast Ruby Web Framework | 573 |
| 6. | [rpplusplus/PokemonHook](https://github.com/rpplusplus/PokemonHook)  | 510 |
| 7. | [substrakt/letsencrypt-heroku](https://github.com/substrakt/letsencrypt-heroku) <br/>Make any Heroku application secure in just a coupl... | 505 |
| 8. | [beweinreich/mlooper](https://github.com/beweinreich/mlooper) <br/>The sp@mlooper | 459 |
| 9. | [amatsuda/jb](https://github.com/amatsuda/jb) <br/>A simple and fast JSON API template engine for Rub... | 413 |
| 10. | [adamcooke/procodile](https://github.com/adamcooke/procodile) <br/>🐊 Run Ruby/Rails processes in the background on Li... | 405 |
| 11. | [EugenMayer/docker-sync](https://github.com/EugenMayer/docker-sync) <br/>Run your application at full speed while syncing y... | 387 |
| 12. | [wojteklu/depcheck](https://github.com/wojteklu/depcheck) <br/>Dependency analyzer tool for Swift projects | 348 |
| 13. | [KrauseFx/overkill](https://github.com/KrauseFx/overkill) <br/>Don't let iTunes interrupt your workflow 💥🎵 | 334 |
| 14. | [antisnatchor/phishlulz](https://github.com/antisnatchor/phishlulz)  | 266 |
| 15. | [github/graphql-client](https://github.com/github/graphql-client) <br/>A Ruby library for declaring, composing and execut... | 258 |
| 16. | [anycable/anycable](https://github.com/anycable/anycable) <br/>Polyglot replacement for ActionCable server | 253 |
| 17. | [antulik/pagelet_rails](https://github.com/antulik/pagelet_rails) <br/>Improve perceived performance of your rails applic... | 233 |
| 18. | [janlelis/whirly](https://github.com/janlelis/whirly) <br/>Colorful Terminal Spinner for Ruby | 211 |
| 19. | [endofunky/oprah](https://github.com/endofunky/oprah) <br/>Opinionated presenters for Rails 5 - without the c... | 209 |
| 20. | [botmetrics/botmetrics](https://github.com/botmetrics/botmetrics) <br/>Analytics and Engagement for Makers and Marketers ... | 197 |
| 21. | [dphuang2/PoGoBag](https://github.com/dphuang2/PoGoBag) <br/>Analyze and share your Pokémon through a locally r... | 175 |
| 22. | [webgradus/kms](https://github.com/webgradus/kms) <br/>Simple and powerful Ruby on Rails CMS for develope... | 165 |
| 23. | [toddwschneider/flim-springfield](https://github.com/toddwschneider/flim-springfield) <br/>Analysis of The Simpsons | 164 |
| 24. | [aleks/ansible-rails](https://github.com/aleks/ansible-rails) <br/>Ansible: Ruby on Rails Server (Ubuntu 16.x) | 163 |
| 25. | [LendingHome/zero_downtime_migrations](https://github.com/LendingHome/zero_downtime_migrations) <br/>Zero downtime migrations with ActiveRecord and Pos... | 160 |
| 26. | [playgroundbooks/playgroundbook](https://github.com/playgroundbooks/playgroundbook) <br/>Tool for Swift Playground books | 150 |
| 27. | [iberianpig/fusuma](https://github.com/iberianpig/fusuma) <br/>Multitouch gestures with libinput dirver on X11, L... | 149 |
| 28. | [bradurani/pg-eyeballs](https://github.com/bradurani/pg-eyeballs) <br/>A Ruby gem for using the postgres explain command ... | 146 |
| 29. | [michaelfeathers/scythe](https://github.com/michaelfeathers/scythe) <br/>A tool for detecting barely used code in productio... | 134 |
| 30. | [blazeeboy/rubrowser](https://github.com/blazeeboy/rubrowser) <br/>a ruby code dependency graph interactive visualize... | 129 |
| 31. | [github/github-graphql-rails-example](https://github.com/github/github-graphql-rails-example) <br/>Example Rails app using GitHub's GraphQL API | 125 |
| 32. | [github/octocatalog-diff](https://github.com/github/octocatalog-diff) <br/>Compile Puppet catalogs from 2 branches, versions,... | 123 |
| 33. | [michenriksen/birdwatcher](https://github.com/michenriksen/birdwatcher) <br/>Data analysis and OSINT framework for Twitter | 121 |
| 34. | [keepcosmos/terjira](https://github.com/keepcosmos/terjira) <br/>Terjira is a very interactive and easy to use CLI ... | 120 |
...
| 24. | [huynhquancam](https://github.com/huynhquancam)  | [worque](https://github.com/huynhquancam/worque)  (111) <br/> | 111 |
...
| Scala | [Repos](https://github.com/donnemartin/gh-stats/blob/master/language_stats/2016/scala.md#most-starred-repos-scala) - [Users](https://github.com/donnemartin/gh-stats/blob/master/language_stats/2016/scala.md