...
| 2. | [AHAAAAAAA/PokemonGo-Map](https://github.com/AHAAAAAAA/PokemonGo-Map) <br/>🌏 Live visualization of all the pokemon in your ar... | 8792 |
...
| 4. | [gztchan/awesome-design](https://github.com/gztchan/awesome-design) <br/>:flags: Best UI/UX Design Resources For Developer ... | 7505 |
| 5. | [255kb/stack-on-a-budget](https://github.com/255kb/stack-on-a-budget) <br/>A collection of services with great free tiers for... | 5636 |
| 6. | [Microsoft/api-guidelines](https://github.com/Microsoft/api-guidelines) <br/>Microsoft REST API Guidelines | 5373 |
| 7. | [engineerapart/TheRemoteFreelancer](https://github.com/engineerapart/TheRemoteFreelancer) <br/>Listing of community-curated resources to find top... | 4304 |
| 8. | [noffle/art-of-readme](https://github.com/noffle/art-of-readme) <br/>:love_letter: Learn the art of writing quality REA... | 4204 |
| 9. | [metagrover/ES6-for-humans](https://github.com/metagrover/ES6-for-humans) <br/>A kickstarter guide to writing ES6. | 4061 |
| 10. | [kelseyhightower/kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) <br/>Bootstrap Kubernetes the hard way on Google Cloud ... | 3211 |
| 11. | [NecronomiconCoding/NecroBot](https://github.com/NecronomiconCoding/NecroBot) <br/>The biggest Pokemon Go Bot in history. Good Bye! | 3111 |
| 12. | [acdlite/react-fiber-architecture](https://github.com/acdlite/react-fiber-architecture) <br/>A description of React's new core algorithm, React... | 2886 |
| 13. | [nothings/single_file_libs](https://github.com/nothings/single_file_libs) <br/>List of single-file C/C++ libraries. | 2489 |
| 14. | [kdeldycke/awesome-falsehood](https://github.com/kdeldycke/awesome-falsehood) <br/>:pill: Curated list of falsehoods programmers beli... | 2353 |
| 15. | [mzlogin/awesome-adb](https://github.com/mzlogin/awesome-adb) <br/>:lollipop: ADB Usage Complete / ADB 用法大全 | 2095 |
| 16. | [AnthonyCalandra/modern-cpp-features](https://github.com/AnthonyCalandra/modern-cpp-features) <br/>A cheatsheet of modern C++ language and library fe... | 2057 |
| 17. | [sqreen/awesome-nodejs-projects](https://github.com/sqreen/awesome-nodejs-projects) <br/>Curated list of awesome open-source applications m... | 2056 |
| 18. | [bnb/awesome-hyper](https://github.com/bnb/awesome-hyper) <br/>🖥 Delightful Hyper plugins, themes, and resources | 1968 |
| 19. | [rstacruz/webpack-tricks](https://github.com/rstacruz/webpack-tricks) <br/>Tips and tricks in using Webpack | 1940 |
| 20. | [VoLuong/Begin-Latex-in-minutes](https://github.com/VoLuong/Begin-Latex-in-minutes) <br/>:bowtie: Brief Intro to LaTeX for beginners that h... | 1852 |
| 21. | [thibmaek/awesome-raspberry-pi](https://github.com/thibmaek/awesome-raspberry-pi) <br/>A curated list of awesome Raspberry Pi tools, proj... | 1759 |
| 22. | [keonkim/awesome-bits](https://github.com/keonkim/awesome-bits) <br/>:computer: A curated list of awesome bitwise opera... | 1705 |
| 23. | [getify/Functional-Light-JS](https://github.com/getify/Functional-Light-JS) <br/>A book about functional programming in JavaScript. | 1645 |
| 24. | [a0viedo/demystifying-js-engines](https://github.com/a0viedo/demystifying-js-engines) <br/>A list of resources about JavaScript engines | 1517 |
| 25. | [jareware/css-architecture](https://github.com/jareware/css-architecture) <br/>8 simple rules for a robust, scalable CSS architec... | 1481 |
| 26. | [HiFaraz/node-playbook](https://github.com/HiFaraz/node-playbook) <br/>Get started fast with Node.js | 1455 |
| 27. | [wbkd/awesome-interactive-journalism](https://github.com/wbkd/awesome-interactive-journalism) <br/>A list of awesome interactive journalism projects. | 1390 |
| 28. | [SmartisanTech/android](https://github.com/SmartisanTech/android) <br/>Smartisan open source code for full build.(repo ma... | 1378 |
| 29. | [heynickc/awesome-ddd](https://github.com/heynickc/awesome-ddd) <br/>A curated list of Domain-Driven Design (DDD), Comm... | 1373 |
| 30. | [BruceDone/awesome-crawler](https://github.com/BruceDone/awesome-crawler) <br/>A collection of awesome web crawler,spider in diff... | 1370 |
| 31. | [timarney/react-faq](https://github.com/timarney/react-faq) <br/>A collection of links to help answer your question... | 1305 |
| 32. | [openimages/dataset](https://github.com/openimages/dataset) <br/>The Open Images dataset | 1301 |
| 33. | [hedengcheng/tech](https://github.com/hedengcheng/tech) <br/>programming, database, distributed system | 1300 |
| 34. | [mandatoryprogrammer/NorthKoreaDNSLeak](https://github.com/mandatoryprogrammer/NorthKoreaDNSLeak) <br/>Snapshot of North Korea's DNS data taken from zone... | 1264 |
...
| 71. | [fchollet/keras-resources](https://github.com/fchollet/keras-resources) <br/>Directory of tutorials and open-source code reposi... | 493 |
...
| 108. | [swift-server/work-group](https://github.com/swift-server/work-group) <br/>Work group steering the development and direction ... | 283 |
...
| 145. | [facert/awesome-spider](https://github.com/facert/awesome-spider) <br/>爬虫集合 | 203 |
...
| 182. | [zeit/awesome-zeit](https://github.com/zeit/awesome-zeit) <br/>The best resources related to ZEIT | 160 |
...
| 219. | [ReactNativeNews/React-Native-Apps](https://github.com/ReactNativeNews/React-Native-Apps) <br/>Curated List of Open Source React Native Apps | 132 |
...
| 117. | [mafintosh](https://github.com/mafintosh)  | [awesome-p2p](https://github.com/mafintosh/awesome-p2p)  (171) <br/> | 171 |
...
| 154. | [PokeBotPub](https://github.com/PokeBotPub)  | [PokeBot-Android](https://github.com/PokeBotPub/PokeBot-Android)  (128) <br/> | 128 |
...
| 188. | [ts25504](https://github.com/ts25504)  | [awesome-koans](https://github.com/ts25504/awesome-koans)  (106) <br/> | 106 |
...
| 19. | [google](https://github.com/google)  | [tiger](https://github