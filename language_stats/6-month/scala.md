...
| | Repo | Stars |
|---|---|---|
| 1. | [intel-analytics/BigDL](https://github.com/intel-analytics/BigDL) <br/>BigDL: Distributed Deep learning Library for Apach... | 468 |
| 2. | [philwantsfish/shard](https://github.com/philwantsfish/shard) <br/>A command line tool to detect shared passwords | 336 |
| 3. | [TalkingData/Fregata](https://github.com/TalkingData/Fregata) <br/>A light weight, super fast, large scale machine le... | 318 |
| 4. | [chrisokasaki/scads](https://github.com/chrisokasaki/scads) <br/>Scala Algorithms and Data Structures | 187 |
| 5. | [akka/akka-http](https://github.com/akka/akka-http) <br/>The Streaming-first HTTP server/module of Akka | 179 |
| 6. | [akka/alpakka](https://github.com/akka/alpakka) <br/>Enterprise Integration Done Right — Alpakka | 178 |
| 7. | [Algomancer/Full-Stack-Scala-Starter](https://github.com/Algomancer/Full-Stack-Scala-Starter) <br/>Play 2.5, ScalaJS, Binding.scala starter project. | 144 |

## Most-Starred Users: Scala

| | User | Repos | Stars |
|---|---|---|---|
| 1. | [philwantsfish](https://github.com/philwantsfish)  | [shard](https://github.com/philwantsfish/shard)  (336) <br/> | 336 |
| 2. | [chrisokasaki](https://github.com/chrisokasaki)  | [scads](https://github.com/chrisokasaki/scads)  (187) <br/> | 187 |
| 3. | [Algomancer](https://github.com/Algomancer)  | [Full-Stack-Scala-Starter](https://github.com/Algomancer/Full-Stack-Scala-Starter)  (144) <br/> | 144 |

## Most-Starred Orgs: Scala

| | Org | Repos | Stars |
|---|---|---|---|
| 1. | [intel-analytics](https://github.com/intel-analytics)  | [BigDL](https://github.com/intel-analytics/BigDL)  (468) <br/> | 468 |
| 2. | [akka](https://github.com/akka)  | [akka-http](https://github.com/akka/akka-http)  (179) <br/>[alpakka](https://github.com/akka/alpakka)  (178) <br/> | 357 |
| 3. | [TalkingData](https://github.com/TalkingData)  | [Fregata](https://github.com/TalkingData/Fregata)  (318) <br/> | 318 |
