...
| | Repo | Stars |
|---|---|---|
| 1. | [ConnorAtherton/loaders.css](https://github.com/ConnorAtherton/loaders.css) <br/>Delightful, performance-focused pure css loading a [...] | 5573 |
| 2. | [primer/primer](https://github.com/primer/primer) <br/>The base coat of GitHub. Our internal CSS toolkit  [...] | 4489 |
| 3. | [connors/photon](https://github.com/connors/photon) <br/>The fastest way to build beautiful Electron apps u [...] | 4122 |
| 4. | [18F/web-design-standards](https://github.com/18F/web-design-standards) <br/>Open source UI components and visual style guide f [...] | 2725 |
| 5. | [horst3180/Arc-theme](https://github.com/horst3180/Arc-theme) <br/>A flat theme with transparent elements | 2383 |
| 6. | [HubPress/hubpress.io](https://github.com/HubPress/hubpress.io) <br/>A web application to build your blog on GitHub | 2163 |
| 7. | [ant-design/ant-design](https://github.com/ant-design/ant-design) <br/>A design language | 2039 |
| 8. | [OfficeDev/Office-UI-Fabric](https://github.com/OfficeDev/Office-UI-Fabric) <br/>The front-end framework for building experiences f [...] | 1812 |
| 9. | [henriquea/minigrid](https://github.com/henriquea/minigrid) <br/>Minimal 2kb zero dependency cascading grid layout | 1548 |
| 10. | [gopatrik/space.js](https://github.com/gopatrik/space.js) <br/> A HTML-driven JavaScript-library for narrative 3D [...] | 1389 |
| 11. | [markdregan/Bayesian-Modelling-in-Python](https://github.com/markdregan/Bayesian-Modelling-in-Python) <br/>A python tutorial on bayesian modeling techniques  [...] | 1217 |
| 12. | [anmoljagetia/Flatabulous](https://github.com/anmoljagetia/Flatabulous) <br/>This is a Flat theme for Ubuntu and other Gnome ba [...] | 1155 |
| 13. | [ctfs/write-ups-2015](https://github.com/ctfs/write-ups-2015) <br/>Wiki-like CTF write-ups repository, maintained by  [...] | 1021 |
| 14. | [tylingsoft/markdown-plus](https://github.com/tylingsoft/markdown-plus) <br/>Markdown Plus ("M+" or "mdp" for short) is a versa [...] | 967 |
| 15. | [LeaVerou/stretchy](https://github.com/LeaVerou/stretchy) <br/>Form element autosizing, the way it should be. | 939 |
| 16. | [mblode/marx](https://github.com/mblode/marx) <br/>The stylish CSS reset. | 900 |
| 17. | [FrontendMasters/front-end-handbook](https://github.com/FrontendMasters/front-end-handbook) <br/>The resources and tools for learning about the pra [...] | 876 |
| 18. | [lmgonzalves/segment](https://github.com/lmgonzalves/segment) <br/>A little JavaScript class (without dependencies) t [...] | 850 |
| 19. | [maxogden/monu](https://github.com/maxogden/monu) <br/>menubar process monitor mac app [ALPHA] | 819 |
| 20. | [anicollection/anicollection](https://github.com/anicollection/anicollection) <br/>The easiest way to find, use and share animations. [...] | 778 |
| 21. | [losvedir/ephemeral2](https://github.com/losvedir/ephemeral2) <br/>Ephemeral P2P over websockets, Phoenix/Elixir. | 753 |
| 22. | [jaicab/localFont](https://github.com/jaicab/localFont) <br/>Implement localStorage web font caching in seconds | 752 |
...
| 30. | [GoogleChrome/big-rig](https://github.com/GoogleChrome/big-rig) <br/>A proof-of-concept Performance Dashboard, CLI and  [...] | 531 |
| 31. | [sconstantinides/FormButtons](https://github.com/sconstantinides/FormButtons) <br/>Forms within buttons, oh my! | 505 |
| 32. | [LukyVj/Colorify.js](https://github.com/LukyVj/Colorify.js) <br/>The simple, customizable, tiny javascript color ex [...] | 479 |
| 33. | [RedHatBrand/overpass](https://github.com/RedHatBrand/overpass) <br/>Overpass open source web font family — Sponsored b [...] | 474 |
| 34. | [shlomi-noach/awesome-mysql](https://github.com/shlomi-noach/awesome-mysql) <br/>A curated list of awesome MySQL software, librarie [...] | 441 |
...
| 71. | [AndrewBelt/WiTeX](https://github.com/AndrewBelt/WiTeX) <br/>If Donald Knuth had designed Wikipedia | 274 |
...
| 108. | [matt-harris/outline](https://github.com/matt-harris/outline) <br/>The clean & simple framework. | 196 |
...
| 145. | [sachinchoolur/angular-flash](https://github.com/sachinchoolur/angular-flash) <br/>A simple lightweight flash message module for angu [...] | 140 |
...
| 45. | [akveo](https://github.com/akveo)  | [angular-progress-button-styles](https://github.com/akveo/angular-progress-button-styles)  (136) <br/> 