...
| | Repo | Stars |
|---|---|---|
| 1. | [Microsoft/WinObjC](https://github.com/Microsoft/WinObjC) <br/>Objective-C for Windows | 4842 |
| 2. | [antirez/disque](https://github.com/antirez/disque) <br/>Disque is a distributed message broker | 4076 |
| 3. | [tmux/tmux](https://github.com/tmux/tmux) <br/>tmux source code | 3639 |
| 4. | [bang590/JSPatch](https://github.com/bang590/JSPatch) <br/>JSPatch bridge Objective-C and Javascript using th [...] | 3300 |
| 5. | [vim/vim](https://github.com/vim/vim) <br/>The official Vim repository | 2754 |
| 6. | [mofarrell/p2pvc](https://github.com/mofarrell/p2pvc) <br/>A point to point color terminal video chat. | 2565 |
| 7. | [mist64/xhyve](https://github.com/mist64/xhyve) <br/>xhyve, a lightweight OS X virtualization solution | 1952 |
| 8. | [hashcat/hashcat](https://github.com/hashcat/hashcat) <br/>Advanced CPU-based password recovery utility | 1902 |
| 9. | [DhavalKapil/icmptunnel](https://github.com/DhavalKapil/icmptunnel) <br/>Transparently tunnel your IP traffic through ICMP  [...] | 1681 |
| 10. | [google/eddystone](https://github.com/google/eddystone) <br/>Specification for Eddystone, an open beacon format [...] | 1562 |
| 11. | [apple/swift-corelibs-foundation](https://github.com/apple/swift-corelibs-foundation) <br/>The Foundation Project, providing core utilities,  [...] | 1492 |
| 12. | [PowerShell/Win32-OpenSSH](https://github.com/PowerShell/Win32-OpenSSH) <br/>Win32 port of OpenSSH | 1292 |
| 13. | [xoreaxeaxeax/movfuscator](https://github.com/xoreaxeaxeax/movfuscator) <br/>The single instruction C compiler | 1267 |
| 14. | [phoboslab/jsmpeg-vnc](https://github.com/phoboslab/jsmpeg-vnc) <br/>A low latency, high framerate screen sharing serve [...] | 1151 |
| 15. | [hashcat/oclHashcat](https://github.com/hashcat/oclHashcat) <br/>World's fastest and most advanced GPGPU-based pass [...] | 1041 |
| 16. | [RPISEC/MBE](https://github.com/RPISEC/MBE) <br/>Course materials for Modern Binary Exploitation by [...] | 1020 |
| 17. | [laruence/php7-internal](https://github.com/laruence/php7-internal) <br/>Understanding PHP7 Internal articles | 955 |
| 18. | [btrask/stronglink](https://github.com/btrask/stronglink) <br/>A searchable, syncable, content-addressable noteta [...] | 936 |
| 19. | [i3/i3](https://github.com/i3/i3) <br/>A better tiling and dynamic window manager | 902 |
| 20. | [cloudwu/mptun](https://github.com/cloudwu/mptun) <br/>Multi-path Tunnel | 868 |
| 21. | [github/brubeck](https://github.com/github/brubeck) <br/>A Statsd-compatible metrics aggregator | 841 |
| 22. | [seppo0010/rlite](https://github.com/seppo0010/rlite) <br/>self-contained, serverless, zero-configuration, tr [...] | 803 |
| 23. | [SirCmpwn/sway](https://github.com/SirCmpwn/sway) <br/>i3-compatible window manager for Wayland (WIP) | 779 |
| 24. | [systemd/systemd](https://github.com/systemd/systemd) <br/>systemd upstream | 759 |
| 25. | [chneukirchen/nq](https://github.com/chneukirchen/nq) <br/>Unix command line queue utility | 756 |
| 26. | [thomasfinch/GammaThingy](https://github.com/thomasfinch/GammaThingy) <br/>Changes screen gamma on iOS, no jailbreak required | 745 |
| 27. | [Cyan4973/zstd](https://github.com/Cyan4973/zstd) <br/>Zstandard - Fast real-time compression algorithm | 720 |
| 28. | [nginx/nginx](https://github.com/nginx/nginx) <br/>An official read-only mirror of http://hg.nginx.or [...] | 704 |
| 29. | [CTurt/PS4-SDK](https://github.com/CTurt/PS4-SDK) <br/>Open source PS4 SDK | 665 |
| 30. | [varnish/hitch](https://github.com/varnish/hitch) <br/>A scalable TLS proxy by Varnish Software. | 627 |
| 31. | [solusipse/ureq](https://github.com/solusipse/ureq) <br/>Micro C library for handling HTTP requests on low  [...] | 607 |
| 32. | [cisco/thor](https://github.com/cisco/thor) <br/>Thor Video Codec | 600 |
...
| 71. | [google/snappy-start](https://github.com/google/snappy-start) <br/>Tool for launching a Linux process from a snapshot | 294 |
...
| 108. | [luohaha/CSpider](https://github.com/luohaha/CSpider) <br/>moved to | 197 |
...
| 145. | [dekuNukem/Amazon_Dash_Button](https://github.com/dekuNukem/Amazon_Dash_Button) <br/>Components and pinouts of Amazon Dash Button | 150 |
...
| Java | [Repos](https://github.com/donnemartin/gh-stats/blo