...
| | Repo | Stars |
|---|---|---|
| 1. | [phanan/koel](https://github.com/phanan/koel) <br/>A personal music streaming server that works. | 4927 |
| 2. | [laravel/lumen](https://github.com/laravel/lumen)  | 3238 |
| 3. | [phptodayorg/php-must-watch](https://github.com/phptodayorg/php-must-watch) <br/>list of interesting conference talks and videos on [...] | 1893 |
| 4. | [hmlb/phpunit-vw](https://github.com/hmlb/phpunit-vw) <br/>VW PHPUnit extension makes your failing test cases [...] | 1587 |
| 5. | [delight-im/FreeGeoDB](https://github.com/delight-im/FreeGeoDB) <br/>Free database of geographic place names and corres [...] | 1515 |
| 6. | [paragonie/awesome-appsec](https://github.com/paragonie/awesome-appsec) <br/>A curated list of resources for learning about app [...] | 1373 |
| 7. | [overtrue/wechat](https://github.com/overtrue/wechat) <br/>可能是目前最优雅的微信公众平台 SDK 了 | 1286 |
| 8. | [tencent-php/tsf](https://github.com/tencent-php/tsf) <br/>coroutine and Swoole based php server framework in [...] | 1121 |
| 9. | [laravel/spark](https://github.com/laravel/spark)  | 1086 |
| 10. | [rlerdorf/php7dev](https://github.com/rlerdorf/php7dev) <br/>Documentation for the php7dev Vagrant box image | 893 |
| 11. | [s4n7h0/xvwa](https://github.com/s4n7h0/xvwa) <br/>XVWA is a badly coded web application written in P [...] | 881 |
| 12. | [rappasoft/laravel-5-boilerplate](https://github.com/rappasoft/laravel-5-boilerplate) <br/>A Laravel 5 Boilerplate Project | 789 |
| 13. | [laracasts/Laravel-5-Generators-Extended](https://github.com/laracasts/Laravel-5-Generators-Extended) <br/>This package extends the core file generators that [...] | 785 |
| 14. | [ErikvdVen/php-gif](https://github.com/ErikvdVen/php-gif)  | 750 |
| 15. | [javiereguiluz/EasyAdminBundle](https://github.com/javiereguiluz/EasyAdminBundle) <br/>The new (and simple) admin generator for Symfony a [...] | 730 |
| 16. | [gherkins/regexpbuilderphp](https://github.com/gherkins/regexpbuilderphp) <br/>human-readable regular expressions for PHP 5.3+ | 719 |
| 17. | [jadjoubran/laravel5-angular-material-starter](https://github.com/jadjoubran/laravel5-angular-material-starter) <br/>Get started with Laravel 5 and Angular (material) | 718 |
| 18. | [etsy/phan](https://github.com/etsy/phan) <br/>Static analyzer for PHP | 671 |
| 19. | [johnlui/Learn-Laravel-5](https://github.com/johnlui/Learn-Laravel-5) <br/>Laravel 5 系列入门教程 代码示例 | 646 |
| 20. | [phpro/grumphp](https://github.com/phpro/grumphp) <br/>A PHP code-quality tool | 616 |
| 21. | [ipfspics/server](https://github.com/ipfspics/server) <br/>Distributed image hosting | 612 |
| 22. | [romanbican/roles](https://github.com/romanbican/roles) <br/>Powerful package for handling roles and permission [...] | 602 |
| 23. | [mitulgolakiya/laravel-api-generator](https://github.com/mitulgolakiya/laravel-api-generator) <br/>Laravel API/Scaffold/CRUD Generator including Cont [...] | 556 |
| 24. | [mdkholy/dashbrew](https://github.com/mdkholy/dashbrew) <br/>Dashbrew is a Vagrant build that aims to provide a [...] | 543 |
| 25. | [AutumnsWind/Front-end-questions-to-the-interview-stage](https://github.com/AutumnsWind/Front-end-questions-to-the-interview-stage) <br/>:snail:最全前端开发面试问题及答案整理 | 535 |
| 26. | [api-platform/api-platform](https://github.com/api-platform/api-platform) <br/>API-first web framework on top of Symfony with JSO [...] | 521 |
| 27. | [Obox/layerswp](https://github.com/Obox/layerswp) <br/>Layers WordPress theme by Obox | 521 |
| 28. | [Pr0x13/iDict](https://github.com/Pr0x13/iDict) <br/>iCloud Apple iD BruteForcer | 485 |
| 29. | [box/spout](https://github.com/box/spout) <br/>Read and write spreadsheet files (CSV, XLSX and OD [...] | 468 |
| 30. | [phpfunct/funct](https://github.com/phpfunct/funct) <br/>A PHP library with commonly used code blocks | 468 |
| 31. | [wealthbot-io/wealthbot](https://github.com/wealthbot-io/wealthbot) <br/>Use wealthbot.io to easily setup your own wealth m [...] | 464 |
| 32. | [spatie/laravel-medialibrary](https://github.com/spatie/laravel-medialibrary) <br/>Associate files with Eloquent models | 459 |
| 33. | [php-school/cli-menu](https://github.com/php-school/cli-menu) <br/>Build beautiful PHP CLI menus. Simple yet Powerful [...] | 447 |
