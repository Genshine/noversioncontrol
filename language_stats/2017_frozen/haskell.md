...
| | Repo | Stars |
|---|---|---|
| 1. | [wireapp/wire-server](https://github.com/wireapp/wire-server) <br/>🇪🇺 Wire back-end services | 1410 |
| 2. | [facebook/duckling](https://github.com/facebook/duckling) <br/>Language, engine, and tooling for expressing, test... | 1246 |
| 3. | [tdietert/nanocoin](https://github.com/tdietert/nanocoin) <br/>A simple cryptocurrency implementation, written to... | 688 |
| 4. | [aviaviavi/legion](https://github.com/aviaviavi/legion) <br/>Simple blockchain server written in haskell. Feedb... | 587 |
| 5. | [def-/time.gif](https://github.com/def-/time.gif) <br/>GIF that always shows the current time in UTC | 408 |
| 6. | [seagreen/Son](https://github.com/seagreen/Son) <br/>A minimal subset of JSON for machine-to-machine co... | 363 |
| 7. | [ollef/sixten](https://github.com/ollef/sixten) <br/>Functional programming with fewer indirections | 312 |
| 8. | [theam/haskell-do](https://github.com/theam/haskell-do) <br/>:pencil2: :bar_chart: - The Haskell code editor fo... | 289 |
| 9. | [iostreamer-X/FuncShell](https://github.com/iostreamer-X/FuncShell) <br/>Improve your shell by making it functional through... | 284 |
| 10. | [chrisdone/jl](https://github.com/chrisdone/jl) <br/>Functional sed for JSON | 273 |
| 11. | [hedgehogqa/haskell-hedgehog](https://github.com/hedgehogqa/haskell-hedgehog) <br/>Hedgehog will eat all your bugs. | 233 |
| 12. | [nstack/nstack](https://github.com/nstack/nstack) <br/>Type-safe, composable microservices for data analy... | 211 |
| 13. | [valderman/selda](https://github.com/valderman/selda) <br/>A type-safe, high-level SQL library for Haskell | 207 |
| 14. | [adjoint-io/nanochain](https://github.com/adjoint-io/nanochain) <br/>A minimal viable blockchain | 180 |
| 15. | [chrisdone/vado](https://github.com/chrisdone/vado) <br/>A web browser engine written in Haskell | 175 |
| 16. | [SimulaVR/Simula](https://github.com/SimulaVR/Simula) <br/>3D Window Manager for Linux | 159 |
| 17. | [llvm-hs/llvm-hs](https://github.com/llvm-hs/llvm-hs) <br/>Haskell bindings for LLVM | 149 |
| 18. | [jonascarpay/apecs](https://github.com/jonascarpay/apecs) <br/>a fast, type driven, extensible ECS for game engin... | 132 |
| 19. | [lettier/movie-monad](https://github.com/lettier/movie-monad) <br/>A desktop video player built with Haskell that use... | 129 |
| 20. | [Ongy/waymonad](https://github.com/Ongy/waymonad) <br/>A wayland compositor based on ideas from and inspi... | 118 |
| 21. | [seagreen/plate](https://github.com/seagreen/plate) <br/>Language-agnostic schemas based on Haskell's type ... | 116 |
| 22. | [GU-CLASP/TypedFlow](https://github.com/GU-CLASP/TypedFlow) <br/>Typed frontend to TensorFlow and higher-order deep... | 116 |
| 23. | [nomeata/ghc-proofs](https://github.com/nomeata/ghc-proofs) <br/>Let GHC prove program equations for you | 113 |
| 24. | [Bose/Smudge](https://github.com/Bose/Smudge) <br/>A domain-specific language for state machines. | 109 |
| 25. | [forest-lang/core](https://github.com/forest-lang/core) <br/>A multi-syntax functional programming language tha... | 109 |
| 26. | [hot-leaf-juice/gotta-go-fast](https://github.com/hot-leaf-juice/gotta-go-fast) <br/>A command line utility for practicing typing and m... | 105 |
| 27. | [samtay/tetris](https://github.com/samtay/tetris) <br/>A terminal interface for Tetris | 105 |
| 28. | [owickstrom/idris-vimscript](https://github.com/owickstrom/idris-vimscript) <br/>Compile Idris to Vimscript, like you always wanted... | 105 |
| 29. | [altercation/dotfiles-tilingwm](https://github.com/altercation/dotfiles-tilingwm) <br/>Tiling window manager related files (XMonad / i3) ... | 103 |
| 30. | [bollu/tiny-optimising-compiler](https://github.com/bollu/tiny-optimising-compiler) <br/>A tiny *optimising* compiler for an imperative pro... | 102 |
| 31. | [goldenlynx/jsn](https://github.com/goldenlynx/jsn) <br/>An absolutely simple & terse CLI app to manipulate... | 102 |
| 32. | [ocharles/micro-ci](https://github.com/ocharles/micro-ci) <br/>A tiny CI server built around GitHub and Nix | 100 |
