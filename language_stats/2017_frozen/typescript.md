...
## Most-Starred Repos: TypeScript

| | Repo | Stars |
|---|---|---|
| 1. | [graphcool/chromeless](https://github.com/graphcool/chromeless) <br/>🖥  Chrome automation made simple. Runs locally or ... | 11516 |
| 2. | [Microsoft/reactxp](https://github.com/Microsoft/reactxp) <br/>Library for cross-platform app development. | 5642 |
| 3. | [PAIR-code/deeplearnjs](https://github.com/PAIR-code/deeplearnjs) <br/>Hardware-accelerated deep learning // machine lear... | 5403 |
| 4. | [jaredpalmer/formik](https://github.com/jaredpalmer/formik) <br/>Build forms in React, without the tears 😭 | 4094 |
| 5. | [Microsoft/TypeScript-React-Starter](https://github.com/Microsoft/TypeScript-React-Starter) <br/>A starter template for TypeScript and React with a... | 3670 |
| 6. | [nestjs/nest](https://github.com/nestjs/nest) <br/>A progressive Node.js framework for building effic... | 2975 |
| 7. | [Microsoft/sqlopsstudio](https://github.com/Microsoft/sqlopsstudio) <br/>SQL Operations Studio is a data management tool th... | 2825 |
| 8. | [AssemblyScript/prototype](https://github.com/AssemblyScript/prototype) <br/>[deprecated] The initial AssemblyScript prototype ... | 2246 |
| 9. | [jaredpalmer/react-fns](https://github.com/jaredpalmer/react-fns) <br/>Browser API's turned into declarative React compon... | 2227 |
| 10. | [NG-ZORRO/ng-zorro-antd](https://github.com/NG-ZORRO/ng-zorro-antd) <br/>An enterprise-class UI components based on Ant Des... | 2059 |
| 11. | [howtographql/howtographql](https://github.com/howtographql/howtographql) <br/>The Fullstack Tutorial for GraphQL | 2029 |
| 12. | [jiayihu/pretty-algorithms](https://github.com/jiayihu/pretty-algorithms) <br/>🌊 Pretty, common and useful algorithms with modern... | 1943 |
| 13. | [ionic-team/stencil](https://github.com/ionic-team/stencil) <br/>Stencil: A Compiler for Web Components | 1807 |
| 14. | [ngrx/platform](https://github.com/ngrx/platform) <br/>Monorepo for ngrx codebase | 1716 |
| 15. | [PolymerLabs/lit-html](https://github.com/PolymerLabs/lit-html) <br/>HTML template literals in JavaScript | 1637 |
| 16. | [meetalva/alva](https://github.com/meetalva/alva) <br/>Alva is a radically new design tool that enables c... | 1484 |
| 17. | [concretesolutions/redux-zero](https://github.com/concretesolutions/redux-zero) <br/>A lightweight state container based on Redux | 1422 |
| 18. | [graphcool/graphql-playground](https://github.com/graphcool/graphql-playground) <br/>🎮  GraphQL IDE for better development workflows (G... | 1293 |
| 19. | [palantir/react-mosaic](https://github.com/palantir/react-mosaic) <br/>A React tiling window manager | 1223 |
| 20. | [sonarwhal/sonarwhal](https://github.com/sonarwhal/sonarwhal) <br/>A linting tool for the web | 1191 |
| 21. | [Shopify/polaris](https://github.com/Shopify/polaris) <br/>Shopify’s product component library | 1117 |
| 22. | [reiinakano/fast-style-transfer-deeplearnjs](https://github.com/reiinakano/fast-style-transfer-deeplearnjs) <br/>Demo of in-browser Fast Neural Style Transfer with... | 1062 |
| 23. | [akveo/nebular](https://github.com/akveo/nebular) <br/>Nebular is a set of essential modules for your nex... | 989 |
| 24. | [cherow/cherow](https://github.com/cherow/cherow) <br/>Very fast, standards-compliant, self-hosted ECMASc... | 820 |
| 25. | [firebase/firebase-js-sdk](https://github.com/firebase/firebase-js-sdk) <br/>Firebase Javascript SDK | 791 |
| 26. | [kactus-io/kactus](https://github.com/kactus-io/kactus) <br/>:cactus: A true version control tool for designers | 760 |
| 27. | [prettier/prettier-vscode](https://github.com/prettier/prettier-vscode) <br/>Visual Studio Code plugin for Prettier | 740 |
| 28. | [mozilla/voice-web](https://github.com/mozilla/voice-web) <br/>Common Voice: Our responsive web, Android and iOS ... | 707 |
| 29. | [joelgriffith/navalia](https://github.com/joelgriffith/navalia) <br/>A bullet-proof, fast, and reliable headless browse... | 705 |
| 30. | [aviabird/angularspree](https://github.com/aviabird/angularspree) <br/>Angular(4.2) E-Commerce front-end framework | 678 |
| 31. | [Microsoft/vscode-recipes](https://github.com/Microsoft/vscode-recipes)  | 630 |
| 32. | [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) <br/>Algorithms and utils for Machine Learning in JavaS... | 628 |
| 33. | [clauderic/react-tiny-virtual-list](https://github.com/clauderic/react-tiny-virtual-list) <br/>A tiny but mighty 3kb list virtualization library,... | 610 |
...
| 37. | [artemsky](https://github.com/artemsky)  | [vue-snotify](https://github.com/artemsky/vue-snotify)  (142) <br/>[ng-snotify](https://github.com/artemsky/ng-snotify)  (132) <br/> | 274 |
...
| 72. | [ktsn](https://github.com/ktsn)  | [vuex-class](https://github.com/ktsn/vuex-class)  (160) <br/> | 160 |
...
| 16. | [Shopify](https://github.com/Shopify)  | [draggable](https://github.com/Shopify/draggable)  (9594) <br/>[bootsnap](https://github.com/Shopify/bootsnap)  (1374) <br/>[polaris](https://github.com/Shopify/polaris)  (1117) <br/>[kubernetes-deploy](https://github.com/Shopify/kubernetes-deploy)  (302) <br/>[FunctionalTableData](https://github.com/Shopify/FunctionalTableData)  (167) <br/>[storefront-api-examples](https://github.com/Shopify/storefront-api-examples)  (107) <br/> | 1117 |
...
| 52. | [WhitestormJS](https://github.com/WhitestormJS)  | [whitestorm-typescript-boilerplate](https://github.com/WhitestormJS/whitestorm-typescript-boilerplate)  (263) <br/> | 263 |
...
| 85. | [jest-community](https://github.com/jest-community)  | [snapshot-diff](https://github.com/jest-community/snapshot-diff)  (200) <br/>[jest-runner-eslint](https://github.com/jest-community/jest-runner-eslint)  (165) <br/>[jest-snapshots-svg](https://github.com/jest-community/jest-snapshots-svg)  (122) <br/>[jest-extended](https://github.com/jest-community/jest-extended)  (106) <br/> | 122 |
