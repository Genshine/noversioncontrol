...
| | Repo | Stars |
|---|---|---|
| 1. | [atech/postal](https://github.com/atech/postal) <br/>📨 A fully featured open source mail delivery platf... | 7493 |
| 2. | [brunofacca/zen-rails-security-checklist](https://github.com/brunofacca/zen-rails-security-checklist) <br/>Checklist of security precautions for Ruby on Rail... | 1378 |
| 3. | [Shopify/bootsnap](https://github.com/Shopify/bootsnap) <br/>Boot large Ruby/Rails apps faster | 1374 |
| 4. | [athityakumar/colorls](https://github.com/athityakumar/colorls) <br/>A Ruby gem that beautifies the terminal's ls comma... | 1273 |
| 5. | [openblockchains/awesome-blockchains](https://github.com/openblockchains/awesome-blockchains) <br/>A collection about awesome blockchains - open dist... | 1225 |
| 6. | [arbox/machine-learning-with-ruby](https://github.com/arbox/machine-learning-with-ruby) <br/>Curated list: Resources for machine learning in Ru... | 779 |
| 7. | [brunofacca/zen-rails-base-app](https://github.com/brunofacca/zen-rails-base-app) <br/>Base application for Ruby on Rails 5 projects. Bui... | 602 |
| 8. | [ankane/dexter](https://github.com/ankane/dexter) <br/>The automatic indexer for Postgres | 520 |
| 9. | [ElevenPaths/Eternalblue-Doublepulsar-Metasploit](https://github.com/ElevenPaths/Eternalblue-Doublepulsar-Metasploit)  | 451 |
| 10. | [pluosi/app-host](https://github.com/pluosi/app-host) <br/>应用内网发布 | iOS OTA (Over-the-Air) | APP publish webs... | 444 |
| 11. | [arbox/data-science-with-ruby](https://github.com/arbox/data-science-with-ruby) <br/>Practical Data Science with Ruby based tools. | 362 |
| 12. | [kbsecret/kbsecret](https://github.com/kbsecret/kbsecret) <br/>A secret manager backed by Keybase and KBFS. | 360 |
| 13. | [palkan/test-prof](https://github.com/palkan/test-prof) <br/>Ruby Tests Profiling Toolbox | 332 |
| 14. | [aderyabin/sniffer](https://github.com/aderyabin/sniffer) <br/>Log and Analyze Outgoing HTTP Requests | 309 |
| 15. | [exAspArk/batch-loader](https://github.com/exAspArk/batch-loader) <br/>:zap: Powerful tool to avoid N+1 DB or HTTP querie... | 303 |
| 16. | [Shopify/kubernetes-deploy](https://github.com/Shopify/kubernetes-deploy) <br/>A command-line tool that helps you ship changes to... | 302 |
| 17. | [david942j/one_gadget](https://github.com/david942j/one_gadget) <br/>A tool for you easy to find the one gadget RCE in ... | 301 |
| 18. | [jamis/castaway](https://github.com/jamis/castaway) <br/>System for building screencasts and video presenta... | 297 |
| 19. | [Anupam-dagar/awesome-first-timers](https://github.com/Anupam-dagar/awesome-first-timers) <br/>Place to contribute if you are a first timer | 288 |
| 20. | [basecamp/geared_pagination](https://github.com/basecamp/geared_pagination) <br/>Paginate Active Record sets at variable speeds | 274 |
| 21. | [shioyama/mobility](https://github.com/shioyama/mobility) <br/>Pluggable Ruby translation framework | 272 |
| 22. | [Sliim/pentest-lab](https://github.com/Sliim/pentest-lab) <br/>Pentest Lab on OpenStack with Heat, Chef provision... | 255 |
| 23. | [ankane/multiverse](https://github.com/ankane/multiverse) <br/>Multiple databases for Rails :tada: | 247 |
| 24. | [gmontard/dockrails](https://github.com/gmontard/dockrails) <br/>Simple CLI to Generate and Run a Rails environment... | 247 |
| 25. | [HatBashBR/HatCloud](https://github.com/HatBashBR/HatCloud) <br/>Bypass CloudFlare with Ruby | 241 |
| 26. | [jcs/bitwarden-ruby](https://github.com/jcs/bitwarden-ruby) <br/>A Bitwarden-compatible API server written in Ruby ... | 238 |
| 27. | [jobertabma/ground-control](https://github.com/jobertabma/ground-control) <br/>A collection of scripts that run on my web server.... | 232 |
| 28. | [bkuhlmann/git-cop](https://github.com/bkuhlmann/git-cop) <br/>Enforces consistent Git commits. | 231 |
| 29. | [rails-engine/action-store](https://github.com/rails-engine/action-store) <br/>Store different kind of actions (Like ❤️, Follow 👁... | 212 |
| 30. | [tombenner/reports_kit](https://github.com/tombenner/reports_kit) <br/>Beautiful, interactive charts and tables for Ruby ... | 209 |
| 31. | [janlelis/uniscribe](https://github.com/janlelis/uniscribe) <br/>Debug help for Unicode strings | 198 |
| 32. | [exAspArk/graphql-guard](https://github.com/exAspArk/graphql-guard) <br/>Simple authorization gem for GraphQL :lock: | 195 |
| 33. | [github/explore](https://github.com/github/explore) <br/>Community-curated topic pages on GitHub | 195 |
