...
| | Repo | Stars |
|---|---|---|
| 1. | [junyanz/CycleGAN](https://github.com/junyanz/CycleGAN) <br/>Software that can generate photos from paintings, ... | 5414 |
| 2. | [facebookresearch/fairseq](https://github.com/facebookresearch/fairseq) <br/>Facebook AI Research Sequence-to-Sequence Toolkit | 2565 |
| 3. | [facebookresearch/ResNeXt](https://github.com/facebookresearch/ResNeXt) <br/>Implementation of a classification framework from ... | 1037 |
| 4. | [leehomyc/Faster-High-Res-Neural-Inpainting](https://github.com/leehomyc/Faster-High-Res-Neural-Inpainting) <br/>High-Resolution Image Inpainting using Multi-Scale... | 892 |
| 5. | [vulnersCom/nmap-vulners](https://github.com/vulnersCom/nmap-vulners) <br/>NSE script based on Vulners.com API | 679 |
| 6. | [jiweil/Neural-Dialogue-Generation](https://github.com/jiweil/Neural-Dialogue-Generation)  | 530 |
| 7. | [scipag/vulscan](https://github.com/scipag/vulscan) <br/>Advanced vulnerability scanning with Nmap NSE | 485 |
| 8. | [hypebeast/micro-auth](https://github.com/hypebeast/micro-auth) <br/>A microservice that makes adding authentication wi... | 441 |
| 9. | [xunhuang1995/AdaIN-style](https://github.com/xunhuang1995/AdaIN-style) <br/>Arbitrary Style Transfer in Real-time with Adaptiv... | 368 |
| 10. | [1adrianb/2D-and-3D-face-alignment](https://github.com/1adrianb/2D-and-3D-face-alignment) <br/>This repository implements a demo of the networks ... | 331 |
| 11. | [yuanfengyun/mj_server](https://github.com/yuanfengyun/mj_server) <br/>房卡类麻将服务器 | 296 |
| 12. | [lifrordi/DeepStack-Leduc](https://github.com/lifrordi/DeepStack-Leduc) <br/>Example implementation of the DeepStack algorithm ... | 244 |
| 13. | [LimBee/NTIRE2017](https://github.com/LimBee/NTIRE2017) <br/>Torch implementation of "Enhanced Deep Residual Ne... | 211 |
| 14. | [facebookresearch/wav2letter](https://github.com/facebookresearch/wav2letter) <br/>Facebook AI Research Automatic Speech Recognition ... | 204 |
| 15. | [Yijunmaverick/UniversalStyleTransfer](https://github.com/Yijunmaverick/UniversalStyleTransfer) <br/>The source code of NIPS17 'Universal Style Transfe... | 194 |
| 16. | [xgastaldi/shake-shake](https://github.com/xgastaldi/shake-shake) <br/>2.86% and 15.85% on CIFAR-10 and CIFAR-100 | 169 |
| 17. | [rameshvarun/NeuralKart](https://github.com/rameshvarun/NeuralKart) <br/>A Real-time Mario Kart AI using CNNs, Offline Sear... | 158 |
| 18. | [stormraiser/GAN-weight-norm](https://github.com/stormraiser/GAN-weight-norm) <br/>Code for "On the Effects of Batch and Weight Norma... | 156 |
| 19. | [deepmind/dqn](https://github.com/deepmind/dqn) <br/>Lua/Torch implementation of DQN (Nature, 2015) | 154 |
| 20. | [robbiebarrat/art-DCGAN](https://github.com/robbiebarrat/art-DCGAN) <br/>Modified implementation of DCGAN focused on genera... | 139 |
| 21. | [gaohuang/MSDNet](https://github.com/gaohuang/MSDNet) <br/>Multi-Scale Dense Convolutional Networks for Effic... | 137 |
| 22. | [batra-mlp-lab/visdial](https://github.com/batra-mlp-lab/visdial) <br/>[CVPR 2017] Torch code for Visual Dialog | 135 |
| 23. | [BeyondTeam/BDReborn](https://github.com/BeyondTeam/BDReborn) <br/>An administration bot based on ➣ https://valtman.n... | 131 |
| 24. | [jakezhaojb/ARAE](https://github.com/jakezhaojb/ARAE) <br/>Code for the paper "Adversarially Regularized Auto... | 130 |
| 25. | [w3h/icsmaster](https://github.com/w3h/icsmaster) <br/>ICS/SCADA Security Resource（整合工控安全相关资源） | 128 |
| 26. | [zhanghang1989/MSG-Net](https://github.com/zhanghang1989/MSG-Net) <br/>Multi-style Generative Network for Real-time Trans... | 122 |
| 27. | [liantian-cn/logitech-pubg](https://github.com/liantian-cn/logitech-pubg) <br/>PUBG no recoil script for Logitech gaming mouse / ... | 120 |
| 28. | [OpenAngelArena/oaa](https://github.com/OpenAngelArena/oaa) <br/>A really great Dota 2 game mode. | 117 |
| 29. | [tanjiti/icstools](https://github.com/tanjiti/icstools) <br/>ics security tools | 115 |
| 30. | [1adrianb/binary-human-pose-estimation](https://github.com/1adrianb/binary-human-pose-estimation) <br/>This code implements a demo of the Binarized Convo... | 107 |
| 31. | [ddtm/deep-smile-warp](https://github.com/ddtm/deep-smile-warp) <br/>DeepWarp for Facial Expression Manipulation | 105 |
