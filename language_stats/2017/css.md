...
| | Repo | Stars |
|---|---|---|
| 1. | [tailwindcss/tailwindcss](https://github.com/tailwindcss/tailwindcss) <br/>A utility-first CSS framework for rapid UI develop... | 3362 |
| 2. | [webkul/coolhue](https://github.com/webkul/coolhue) <br/>Coolest Gradient Hues and Swatches by UVdesk | 2134 |
| 3. | [tastejs/hacker-news-pwas](https://github.com/tastejs/hacker-news-pwas) <br/>HNPWA - Hacker News readers as Progressive Web App... | 1637 |
| 4. | [RyanFitzgerald/devportfolio](https://github.com/RyanFitzgerald/devportfolio) <br/>A lightweight, customizable single-page personal p... | 1586 |
| 5. | [claviska/shoelace-css](https://github.com/claviska/shoelace-css) <br/>A back to the basics CSS starter kit. | 1505 |
| 6. | [android/kotlin-guides](https://github.com/android/kotlin-guides) <br/>A set of guides for writing Kotlin for Android. | 1397 |
| 7. | [IBM/type](https://github.com/IBM/type) <br/>The package of IBM’s new typeface, IBM Plex, and a... | 1395 |
| 8. | [GoogleChrome/essential-image-optimization](https://github.com/GoogleChrome/essential-image-optimization) <br/>Essential Image Optimization - an eBook | 1326 |
| 9. | [creativetimofficial/now-ui-kit](https://github.com/creativetimofficial/now-ui-kit) <br/>Now UI Kit Bootstrap 4 - Designed by Invision. Cod... | 1269 |
| 10. | [Martz90/vivify](https://github.com/Martz90/vivify) <br/>Vivify is free CSS animation library. | 1234 |
| 11. | [Chalarangelo/mocka](https://github.com/Chalarangelo/mocka) <br/>Simple, elegant content placeholder | 1183 |
| 12. | [Microsoft/TypeScript-Node-Starter](https://github.com/Microsoft/TypeScript-Node-Starter) <br/>A starter template for TypeScript and Node with a ... | 1180 |
| 13. | [waylybaye/HyperApp-Guide](https://github.com/waylybaye/HyperApp-Guide) <br/>HyperApp user's manual | 1098 |
| 14. | [itmeo/webgradients](https://github.com/itmeo/webgradients) <br/>A curated collection of splendid gradients made in... | 1086 |
| 15. | [DennisSnijder/MakeGithubGreatAgain](https://github.com/DennisSnijder/MakeGithubGreatAgain) <br/>Extension for making GitHub great again | 1025 |
| 16. | [OYsun/VueCircleMenu](https://github.com/OYsun/VueCircleMenu) <br/>:rabbit:A beautiful circle menu powered by Vue.js | 929 |
| 17. | [picturepan2/devices.css](https://github.com/picturepan2/devices.css) <br/>Devices.css - Modern devices in pure CSS | 874 |
| 18. | [C-JSN/D3-ID3](https://github.com/C-JSN/D3-ID3) <br/>iD3: an Integrated Development Environment for D3.... | 781 |
| 19. | [alexgreene/WikiQuiz](https://github.com/alexgreene/WikiQuiz) <br/>Generates a quiz for a Wikipedia page using parts ... | 730 |
| 20. | [ghosh/microtip](https://github.com/ghosh/microtip) <br/>💬  Modern, minimal, a11y enabled, ultra lightweigh... | 682 |
| 21. | [benbrignell/principles.design](https://github.com/benbrignell/principles.design) <br/>Work in progress repository of design principles a... | 673 |
| 22. | [raymestalez/nulis](https://github.com/raymestalez/nulis) <br/>Tree editor for writers | 671 |
| 23. | [spymastermatt/thunderbird-monterail](https://github.com/spymastermatt/thunderbird-monterail) <br/>A set of themes for thunderbird inspired by a Mont... | 659 |
| 24. | [brentsimmons/JSONFeed](https://github.com/brentsimmons/JSONFeed) <br/>The JSONFeed.org website | 652 |
| 25. | [AnomalyInnovations/serverless-stack-com](https://github.com/AnomalyInnovations/serverless-stack-com) <br/>Source for Serverless-Stack.com | 637 |
| 26. | [picturepan2/instagram.css](https://github.com/picturepan2/instagram.css) <br/>Complete set of Instagram filters in pure CSS | 614 |
| 27. | [lucasgruwez/waffle-grid](https://github.com/lucasgruwez/waffle-grid) <br/>An easy to use flexbox grid system. | 587 |
| 28. | [ermongroup/cs228-notes](https://github.com/ermongroup/cs228-notes) <br/>Course notes for CS228: Probabilistic Graphical Mo... | 564 |
| 29. | [crazychicken/t-scroll](https://github.com/crazychicken/t-scroll) <br/>A modern reveal-on-scroll library with useful opti... | 549 |
| 30. | [DesignRevision/shards-ui](https://github.com/DesignRevision/shards-ui) <br/>Shards is a free and modern Bootstrap 4 UI toolkit... | 547 |
| 31. | [BretFisher/udemy-docker-mastery](https://github.com/BretFisher/udemy-docker-mastery) <br/>Udemy Course to build, compose, deploy, and manage... | 533 |
| 32. | [balzss/luxbar](https://github.com/balzss/luxbar) <br/>:cocktail: Featherweight, Responsive, CSS Only Nav... | 533 |
| 33. | [lin-xin/blog](https://github.com/lin-xin/blog) <br/>林鑫的个人博客，用于总结平时工作和学习中的经验。 | 525 |
| 34. | [widget-/slack-black-theme](https://github.com/widget-/slack-black-theme) <br/>A darker, more contrasty, Slack theme. | 506 |
...
| 71. | [LinxGem33/OSX-Arc-Darker](https://github.com/LinxGem33/OSX-Arc-Darker) <br/>a flat theme collection based on arc with transpar... | 201 |
...
| 108. | [CreditEaseDBA/Themis](https://github.com/CreditEaseDBA/Themis) <br/>数据库审核平台 | 133 |
...
| 145. | [OnebugIS/React---project](https://github.com/OnebugIS/React---project) <br/>基于React构造的桐乡网 | 107 |
...
| 28. | [Aris-t2](https://github.com/Aris-t2)  | [CustomCSSforFx](https://github.com/Aris-t2/CustomCSSforFx)  (374) <br/> | 374 |
...
| 65. | [stkevintan](https://github.com/stkevintan)  | [hexo-theme-material-flow](https://github.com/stkevintan/hexo-theme-material-flow)  (157) <br/> | 157 |
...
| 95. | [erictreacy](https://github.com/erictreacy)  | [mimic.css](https://github.com/erictreacy/mimic.css)  (113) <br/> | 113 |
...
| 28. | [DXY-F2E](https://github.com/DXY-F2E)  | [api-mocker](https://github.com/DXY-F2E/api-mocker)  (491) <br/>[dxy-ui](https://github.com/DXY-F2E/dxy-ui)  (130) <br/> | 130 |
