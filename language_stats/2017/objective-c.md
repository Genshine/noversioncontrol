...
| | Repo | Stars |
|---|---|---|
| 1. | [TKkk-iOSer/WeChatPlugin-MacOS](https://github.com/TKkk-iOSer/WeChatPlugin-MacOS) <br/>mac OS版微信小助手 功能: 自动回复、消息防撤回、远程控制、微信多开、会话置底、免认证登录、窗... | 2879 |
| 2. | [pojala/electrino](https://github.com/pojala/electrino) <br/>Desktop runtime for apps built on web technologies... | 2854 |
| 3. | [TextureGroup/Texture](https://github.com/TextureGroup/Texture) <br/>Smooth asynchronous user interfaces for iOS apps. | 2602 |
| 4. | [linkedin/bluepill](https://github.com/linkedin/bluepill) <br/>Bluepill is a reliable iOS testing tool that runs ... | 2513 |
| 5. | [Naituw/IPAPatch](https://github.com/Naituw/IPAPatch) <br/>Patch iOS Apps, The Easy Way, Without Jailbreak. | 2160 |
| 6. | [kpwn/yalu102](https://github.com/kpwn/yalu102) <br/>incomplete iOS 10.2 jailbreak for 64 bit devices b... | 1739 |
| 7. | [Sunnyyoung/WeChatTweak-macOS](https://github.com/Sunnyyoung/WeChatTweak-macOS) <br/>A dynamic library tweak for WeChat macOS - 微信 macO... | 1470 |
| 8. | [twitter/ios-twitter-image-pipeline](https://github.com/twitter/ios-twitter-image-pipeline) <br/>Twitter Image Pipeline is a robust and performant ... | 1448 |
| 9. | [wangrui460/WRNavigationBar](https://github.com/wangrui460/WRNavigationBar) <br/>超简单！！！ 一行代码设置状态栏、导航栏按钮、标题、颜色、透明度，移动等    WRNavigat... | 1357 |
| 10. | [alibaba/LazyScrollView](https://github.com/alibaba/LazyScrollView) <br/>An iOS ScrollView to resolve the problem of reusab... | 1198 |
| 11. | [AloneMonkey/MonkeyDev](https://github.com/AloneMonkey/MonkeyDev) <br/>CaptainHook Tweak、Logos Tweak and Command-line Too... | 1185 |
| 12. | [KrauseFx/detect.location](https://github.com/KrauseFx/detect.location) <br/>An easy way to access the user's iOS location data... | 1172 |
| 13. | [willowtreeapps/Hyperion-iOS](https://github.com/willowtreeapps/Hyperion-iOS) <br/>In-app design review tool to inspect measurements,... | 1166 |
| 14. | [halfrost/Halfrost-Field](https://github.com/halfrost/Halfrost-Field) <br/>✍️ 这里是写博客的地方 —— Halfrost-Field 冰霜之地 | 1094 |
| 15. | [libobjc/SGPlayer](https://github.com/libobjc/SGPlayer) <br/>A powerful media player framework for iOS, macOS, ... | 1060 |
| 16. | [TKkk-iOSer/WeChatPlugin-iOS](https://github.com/TKkk-iOSer/WeChatPlugin-iOS) <br/>iOS 版微信小助手(防撤回、修改微信运动、游戏作弊、群管理、好友请求管理) | 1035 |
| 17. | [AAChartModel/AAChartKit](https://github.com/AAChartModel/AAChartKit) <br/>An elegant and friendly chart library for iOS deve... | 1031 |
| 18. | [waylybaye/XcodeCleaner](https://github.com/waylybaye/XcodeCleaner) <br/>Cleaner for Xcode.app built with react-native-maco... | 1021 |
| 19. | [XuYang8026/UniversalProject](https://github.com/XuYang8026/UniversalProject) <br/>基于MVC架构的iOS轻量级框架，封装了基类、基于猿题库YTKNetwork的网络服务、工具库，Na... | 892 |
| 20. | [snail-z/zhPopupController](https://github.com/snail-z/zhPopupController) <br/>Popup your custom view is easy, support custom mas... | 886 |
| 21. | [jkpang/PPRows](https://github.com/jkpang/PPRows) <br/>It Can Calculate how many lines of code you write ... | 869 |
| 22. | [alibaba/Tangram-iOS](https://github.com/alibaba/Tangram-iOS) <br/>Tangram is a modular UI solution for building nati... | 854 |
| 23. | [ChangbaDevs/KTVHTTPCache](https://github.com/ChangbaDevs/KTVHTTPCache) <br/>A media cache framework from Changba iOS Team. | 850 |
| 24. | [HippoAR/react-native-arkit](https://github.com/HippoAR/react-native-arkit) <br/>React Native binding for iOS ARKit | 807 |
| 25. | [yulingtianxia/FishChat](https://github.com/yulingtianxia/FishChat) <br/>Hook WeChat.app on non-jailbroken devices. | 801 |
| 26. | [zhongfenglee/IDCardRecognition](https://github.com/zhongfenglee/IDCardRecognition) <br/>中国大陆第二代身份证识别，自动读出身份证上的信息（姓名、性别、民族、住址、身份证号码）并截取身份证照... | 792 |
| 27. | [insidegui/AnimojiStudio](https://github.com/insidegui/AnimojiStudio) <br/>Make Animoji videos with unlimited duration and sh... | 748 |
| 28. | [music4kid/TKeyboard](https://github.com/music4kid/TKeyboard) <br/>Mac and iOS projects for TKeyboard, Enjoy | 741 |
| 29. | [simonbs/SBSAnimoji](https://github.com/simonbs/SBSAnimoji) <br/>🐵 Animoji app using Apples AvatarKit | 705 |
| 30. | [XVimProject/XVim2](https://github.com/XVimProject/XVim2) <br/>Vim key-bindings for Xcode 9 | 670 |
| 31. | [LoveZYForever/HXWeiboPhotoPicker](https://github.com/LoveZYForever/HXWeiboPhotoPicker) <br/>照片/图片选择器 - 支持LivePhoto、GIF图片选择、3DTouch预览、在线下载iClou... | 588 |
| 32. | [coderMyy/CocoaAsyncSocket_Demo](https://github.com/coderMyy/CocoaAsyncSocket_Demo) <br/>基于AsyncSocket搭建即时通讯体系 . 包含TCP连接 , 消息发送 , 消息接收 , 心跳... | 517 |
| 33. | [imlifengfeng/FFToast](https://github.com/imlifengfeng/FFToast) <br/>A very powerful iOS message notifications and Aler... | 515 |
...
| 26. | [CustomPBWaters](https://github.com/CustomPBWaters)  | [Apple-GitHub-Codeidea](https://github.com/CustomPBWaters/Apple-GitHub-Codeidea)  (467) <br/>[Framework-Codeidea](https://github.com/CustomPBWaters/Framework-Codeidea)  (244) <br/> | 711 |
...
| 60. | [milgra](https://github.com/milgra)  | [highsierramediakeyenabler](https://github.com/milgra/highsierramediakeyenabler)  (285) <br/> | 285 |
...
| 97. | [kingsic](https://github.com/kingsic)  | [SGAdvertScrollView](https://github.com/kingsic/SGAdvertScrollView)  (202) <br/> | 202 |
...
| 130. | [SPStore](https://github.com/SPStore)  | [HVScrollView](https://github.com/SPStore/HVScrollView)  (140) <br/> | 140 |
...
| 167. | [yixiangboy](https://github.com/yixiangboy)  | [YXViewPager](https://github.com/yixiangboy/YXViewPager)  (101) <br/> | 101 |
