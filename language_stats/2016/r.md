...
| | Repo | Stars |
|---|---|---|
| 1. | [zonination/investing](https://github.com/zonination/investing) <br/>Investing Returns on the Market as a Whole | 1517 |
| 2. | [rstudio/tensorflow](https://github.com/rstudio/tensorflow) <br/>TensorFlow for R | 526 |
| 3. | [dgrtwo/gganimate](https://github.com/dgrtwo/gganimate) <br/>Create easy animations with ggplot2 | 329 |
| 4. | [slowkow/ggrepel](https://github.com/slowkow/ggrepel) <br/>:round_pushpin: Repel overlapping text labels away... | 328 |
| 5. | [juliasilge/tidytext](https://github.com/juliasilge/tidytext) <br/>Text mining using dplyr, ggplot2, and other tidy t... | 317 |
| 6. | [ben519/MLPB](https://github.com/ben519/MLPB) <br/>Machine Learning Problem Bible | 283 |
| 7. | [toddwschneider/ballr](https://github.com/toddwschneider/ballr) <br/>Interactive NBA Shot Charts with R and Shiny | 277 |
| 8. | [rstudio/sparklyr](https://github.com/rstudio/sparklyr) <br/>R interface for Apache Spark | 273 |
| 9. | [thomasp85/ggraph](https://github.com/thomasp85/ggraph) <br/>Grammar of Graph Graphics | 267 |
| 10. | [tidyverse/tidyverse](https://github.com/tidyverse/tidyverse) <br/>Easily install and load packages from the tidyvers... | 248 |
| 11. | [csgillespie/efficientR](https://github.com/csgillespie/efficientR) <br/>Efficient R programming: a book | 214 |
| 12. | [daattali/addinslist](https://github.com/daattali/addinslist) <br/>Discover and install useful RStudio addins | 202 |
| 13. | [softdorothy/glider_pro](https://github.com/softdorothy/glider_pro) <br/>Sources for the Macintosh game, Glider PRO, writte... | 190 |
| 14. | [rstudio/RStartHere](https://github.com/rstudio/RStartHere) <br/>A guide to some of the most useful R Packages that... | 187 |
| 15. | [dgrtwo/fuzzyjoin](https://github.com/dgrtwo/fuzzyjoin) <br/>Join tables together on inexact matching | 177 |
| 16. | [thomasp85/tweenr](https://github.com/thomasp85/tweenr) <br/>Interpolate your data | 162 |
| 17. | [tidyverse/forcats](https://github.com/tidyverse/forcats) <br/>🐈🐈🐈🐈: tools for working with categorical variables... | 159 |
| 18. | [calligross/ggthemeassist](https://github.com/calligross/ggthemeassist) <br/>An RStudio addin for ggplot2 theme tweaking | 157 |
| 19. | [walkerkq/textmining_southpark](https://github.com/walkerkq/textmining_southpark)  | 155 |
| 20. | [sfirke/janitor](https://github.com/sfirke/janitor) <br/>simple tools for data cleaning in R | 150 |
| 21. | [hadley/modelr](https://github.com/hadley/modelr) <br/>Helper functions for modelling | 148 |
| 22. | [thomasp85/ggforce](https://github.com/thomasp85/ggforce) <br/>Accelerating ggplot2 | 143 |
| 23. | [ropensci/tabulizer](https://github.com/ropensci/tabulizer) <br/>Bindings for Tabula PDF Table Extractor Library | 139 |
| 24. | [ben519/DataWrangling](https://github.com/ben519/DataWrangling) <br/>The ultimate reference guide to data wrangling wit... | 130 |
| 25. | [rstudio/blogdown](https://github.com/rstudio/blogdown) <br/>Create Blogs and Websites with R Markdown | 128 |
| 26. | [daattali/timevis](https://github.com/daattali/timevis) <br/>Create interactive timeline visualizations in R | 127 |
| 27. | [FreeCodeCamp/2016-new-coder-survey](https://github.com/FreeCodeCamp/2016-new-coder-survey)  | 127 |
| 28. | [Microsoft/SQL-Server-R-Services-Samples](https://github.com/Microsoft/SQL-Server-R-Services-Samples) <br/>Advanced analytics samples and templates using SQL... | 126 |
| 29. | [yihui/xaringan](https://github.com/yihui/xaringan) <br/>Presentation Ninja 幻灯忍者 · 写轮眼 | 125 |
| 30. | [fivethirtyeight/guns-data](https://github.com/fivethirtyeight/guns-data)  | 122 |
| 31. | [toddwschneider/nyc-citibike-data](https://github.com/toddwschneider/nyc-citibike-data) <br/>NYC Citi Bike system data and analysis | 120 |

## Most-Starred Users: R

| | User | Repos | Stars |
|---|---|---|---|
| 1. | [zonination](https://github.com/zonination)  | [investing](https://github.com/zonination/investing)  (1517) <br/> | 1517 |
| 2. | [thomasp85](https://github.com/thomasp85)  | [ggraph](https://github.com/thomasp85/ggraph)  (267) <br/>[tweenr](https://github.com/thomasp85/tweenr)  (162) <br/>[ggforce](https://github.com/thomasp85/ggforce)  (143) <br/> | 572 |
| 3. | [dgrtwo](https://github.com/dgrtwo)  | [gganimate](https://github.com/dgrtwo/gganimate)  (329) <br/>[fuzzyjoin](https://github.com/dgrtwo/fuzzyjoin)  (177) <br/>[tidy-text-mining](https://github.com/dgrtwo/tidy-text-mining)  (132) <br/> | 506 |
| 4. | [ben519](https://github.com/ben519)  | [MLPB](https://github.com/ben519/MLPB)  (283) <br/>[DataWrangling](https://github.com/ben519/DataWrangling)  (130) <br/> | 413 |
| 5. | [toddwschneider](https://github.com/toddwschneider)  | [ballr](https://github.com/toddwschneider/ballr)  (277) <br/>[flim-springfield](https://github.com/toddwschneider/flim-springfield)  (164) <br/>[nyc-citibike-data](https://github.com/toddwschneider/nyc-citibike-data)  (120) <br/> | 397 |
| 6. | [daattali](https://github.com/daattali)  | [addinslist](https://github.com/daattali/addinslist)  (202) <br/>[timevis](https://github.com/daattali/timevis)  (127) <br/> | 329 |
| 7. | [slowkow](https://github.com/slowkow)  | [ggrepel](https://github.com/slowkow/ggrepel)  (328) <br/> | 328 |
| 8. | [juliasilge](https://github.com/juliasilge)  | [tidytext](https://github.com/juliasilge/tidytext)  (317) <br/> | 317 |
| 9. | [csgillespie](https://github.com/csgillespie)  | [efficientR](https://github.com/csgillespie/efficientR)  (214) <br/> | 214 |
| 10. | [softdorothy](https://github.com/softdorothy)  | [glider_pro](https://github.com/softdorothy/glider_pro)  (190) <br/> | 190 |
| 11. | [calligross](https://github.com/calligross)  | [ggthemeassist](https://github.com/calligross/ggthemeassist)  (157) <br/> | 157 |
| 12. | [walkerkq](https://github.com/walkerkq)  | [textmining_southpark](https://github.com/walkerkq/textmining_southpark)  (155) <br/> | 155 |
| 13. | [sfirke](https://github.com/sfirke)  | [janitor](https://github.com/sfirke/janitor)  (150) <br/> | 150 |
| 14. | [hadley](https://github.com/hadley)  | [modelr](https://github.com/hadley/modelr)  (148) <br/> | 148 |
| 15. | [yihui](https://github.com/yihui)  | [xaringan](https://github.com/yihui/xaringan)  (125) <br/> | 125 |

## Most-Starred Orgs: R

| | Org | Repos | Stars |
|---|---|---|---|
| 1. | [rstudio](https://github.com/rstudio)  | [tensorflow](https://github.com/rstudio/tensorflow)  (526) <br/>[sparklyr](https://github.com/rstudio/sparklyr)  (273) <br/>[RStartHere](https://github.com/rstudio/RStartHere)  (187) <br/>[flexdashboard](https://github.com/rstudio/flexdashboard)  (144) <br/>[blogdown](https://github.com/rstudio/blogdown)  (128) <br/> | 1114 |
| 2. | [tidyverse](https://github.com/tidyverse)  | [tidyverse](https://github.com/tidyverse/tidyverse)  (248) <br/>[forcats](https://github.com/tidyverse/forcats)  (159) <br/> | 407 |
| 3. | [ropensci](https://github.com/ropensci)  | [tabulizer](https://github.com/ropensci/tabulizer)  (139) <br/>[magick](https://github.com/ropensci/magick)  (106) <br/> | 139 |
| 4. | [FreeCodeCamp](https://github.com/FreeCodeCamp)  | [2016-new-coder-survey](https://github.com/FreeCodeCamp/2016-new-coder-survey)  (127) <br/>[nonprofit-email-service](https://github.com/FreeCodeCamp/nonprofit-email-service)  (109) <br/> | 127 |
| 5. | [Microsoft](https://github.com/Microsoft)  | [ChakraCore](https://github.com/Microsoft/ChakraCore)  (5907) <br/>[monaco-editor](https://github.com/Microsoft/monaco-editor)  (3499) <br/>[BotBuilder](https://github.com/Microsoft/BotBuilder)  (3299) <br/>[malmo](https://github.com/Microsoft/malmo)  (2208) <br/>[LightGBM](https://github.com/Microsoft/LightGBM)  (1706) <br/>[UWPCommunityToolkit](https://github.com/Microsoft/UWPCommunityToolkit)  (991) <br/>[HoloJS](https://github.com/Microsoft/HoloJS)  (798) <br/>[GalaxyExplorer](https://github.com/Microsoft/GalaxyExplorer)  (672) <br/>[HoloToolkit-Unity](https://github.com/Microsoft/HoloToolkit-Unity)  (467) <br/>[cppwinrt](https://github.com/Microsoft/cppwinrt)  (351) <br/>[ProjectOxford-Apps-MimickerAlarm](https://github.com/Microsoft/ProjectOxford-Apps-MimickerAlarm)  (310) <br/>[CSharpClient-for-Kafka](https://github.com/Microsoft/CSharpClient-for-Kafka)  (306) <br/>[aspnet-api-versioning](https://github.com/Microsoft/aspnet-api-versioning)  (253) <br/>[mssql-jdbc](https://github.com/Microsoft/mssql-jdbc)  (246) <br/>[Mesh-processing-library](https://github.com/Microsoft/Mesh-processing-library)  (243) <br/>[dafny](https://github.com/Microsoft/dafny)  (230) <br/>[thrifty](https://github.com/Microsoft/thrifty)  (224) <br/>[Appsample-Photosharing](https://github.com/Microsoft/Appsample-Photosharing)  (207) <br/>[WinAppDriver](https://github.com/Microsoft/WinAppDriver)  (191) <br/>[DirectXMath](https://github.com/Microsoft/DirectXMath)  (187) <br/>[BikeSharing360_MobileApps](https://github.com/Microsoft/BikeSharing360_MobileApps)  (180) <br/>[BotBuilder-Samples](https://github.com/Microsoft/BotBuilder-Samples)  (176) <br/>[Docker-PowerShell](https://github.com/Microsoft/Docker-PowerShell)  (173) <br/>[vsts-agent](https://github.com/Microsoft/vsts-agent)  (168) <br/>[uwp-experiences](https://github.com/Microsoft/uwp-experiences)  (149) <br/>[AzureUsageAndBillingPortal](https://github.com/Microsoft/AzureUsageAndBillingPortal)  (130) <br/>[SQL-Server-R-Services-Samples](https://github.com/Microsoft/SQL-Server-R-Services-Samples)  (126) <br/>[IIS.Administration](https://github.com/Microsoft/IIS.Administration)  (122) <br/>[DirectXTK12](https://github.com/Microsoft/DirectXTK12)  (117) <br/>[checkedc-clang](https://github.com/Microsoft/checkedc-clang)  (110) <br/> | 126 |
| 6. | [fivethirtyeight](https://github.com/fivethirtyeight)  | [d3-pre](https://github.com/fivethirtyeight/d3-pre)  (450) <br/>[guns-data](https://github.com/fivethirtyeight/guns-data)  (122) <br/> | 122 |
