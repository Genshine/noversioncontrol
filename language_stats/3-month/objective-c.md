...
| 3. | [bikkelbroeders/TouchBarDemoApp](https://github.com/bikkelbroeders/TouchBarDemoApp) <br/>Allows you to use your macOS Touch Bar from an iPa... | 1481 |
| 4. | [iphone5solo/PYSearch](https://github.com/iphone5solo/PYSearch) <br/>🔍 An elegant search controller which replaces the ... | 1358 |
| 5. | [gyjzh/LLWeChat](https://github.com/gyjzh/LLWeChat) <br/>实现IM基本功能，并且在细节、完成度、bugfree上媲美任何主流IM应用 | 690 |
| 6. | [cyanzhong/Retriever](https://github.com/cyanzhong/Retriever) <br/>Retrieving InfoPlist without Jailbreaking on iOS D... | 634 |
| 7. | [ptmt/react-native-touchbar](https://github.com/ptmt/react-native-touchbar) <br/>TouchBar for react-native-macos | 617 |
| 8. | [QMUI/QMUI_iOS](https://github.com/QMUI/QMUI_iOS) <br/>QMUI iOS——致力于提高项目 UI 开发效率的解决方案 | 614 |
| 9. | [googlecreativelab/Sprayscape](https://github.com/googlecreativelab/Sprayscape) <br/>Sprayscape is a perfectly imperfect VR-ish camera.... | 460 |
| 10. | [kangzubin/XMNetworking](https://github.com/kangzubin/XMNetworking) <br/>A lightweight but powerful network library with si... | 436 |
| 11. | [liuzhiyi1992/ZYSideSlipFilter](https://github.com/liuzhiyi1992/ZYSideSlipFilter) <br/>Awesome side slip filter for your display rack, 侧边... | 373 |
| 12. | [castial/HYFileManager](https://github.com/castial/HYFileManager) <br/>HYFileManager is a powerful util based on NSFileMa... | 312 |
| 13. | [yate1996/YYStock](https://github.com/yate1996/YYStock) <br/>iOS股票K线第二版：整合了分时图，日周月K线图，五档图，长按，捏合缩放，全屏非全屏切换自适应 | 304 |
| 14. | [zhengwenming/WMDragView](https://github.com/zhengwenming/WMDragView) <br/>拖吗？拖！拖就用WMDragView吧。WMDragView致力于让任意View都可以自由拖动。 | 277 |
| 15. | [brentsimmons/Vesper](https://github.com/brentsimmons/Vesper) <br/>Vesper is a note-taking app for iOS by Q Branch. | 272 |
| 16. | [iphone5solo/PYTheme](https://github.com/iphone5solo/PYTheme) <br/>An easy way to change theme through NSObject's cat... | 253 |
| 17. | [youusername/magnetX](https://github.com/youusername/magnetX) <br/>资源搜索型软件 macOS OSX magnet | 252 |
| 18. | [hamzasood/pam_touchid](https://github.com/hamzasood/pam_touchid) <br/>A PAM module for authentication with Touch ID | 235 |
| 19. | [ming1016/STMURLCache](https://github.com/ming1016/STMURLCache) <br/>iOS预加载Web页面方案 | 227 |
| 20. | [EnjoySR/ESPictureBrowser](https://github.com/EnjoySR/ESPictureBrowser) <br/>一个集成简单交互效果不错的图片浏览器😄 | 222 |
| 21. | [tingxins/TXScrollLabelView](https://github.com/tingxins/TXScrollLabelView) <br/>TXScrollLabelView (Objective-C), the best way to s... | 215 |
| 22. | [southpeak/Minya](https://github.com/southpeak/Minya) <br/>A simple basic hierarchy for iOS development with ... | 195 |
| 23. | [tiantianlan/LiveExplanation](https://github.com/tiantianlan/LiveExplanation) <br/>直播技术的总结 | 179 |
| 24. | [jkpang/PPCounter](https://github.com/jkpang/PPCounter) <br/>一款优雅的数字/金额增减动效控件,支持UILabel、UIButton显示 | 178 |
| 25. | [zekunyan/TTGPuzzleVerify](https://github.com/zekunyan/TTGPuzzleVerify) <br/>By completing image puzzle game, TTGPuzzleVerify i... | 171 |
| 26. | [music4kid/EasyCode-Xcode](https://github.com/music4kid/EasyCode-Xcode) <br/>"legal" Xcode Plugin for inserting code in super d... | 145 |
| 27. | [CoderVan/Yeshijia-APP](https://github.com/CoderVan/Yeshijia-APP) <br/>高仿  悦食家APP 相似度 | 142 |
| 28. | [dhirajjadhao/Newly](https://github.com/dhirajjadhao/Newly) <br/>Newly is a drop in solution to add Twitter/Faceboo... | 137 |
| 29. | [netyouli/WHC_KeyboardManager](https://github.com/netyouli/WHC_KeyboardManager) <br/>iOS平台轻量级的键盘管理器，使用简单功能强大，键盘再也不会挡住输入控件 | 131 |
| 30. | [lyb5834/YBPopupMenu](https://github.com/lyb5834/YBPopupMenu) <br/>快速集成popupMenu | 126 |
| 31. | [emoRaivis/MacMorpheus](https://github.com/emoRaivis/MacMorpheus) <br/>3D 180/360 video player for macOS and PSVR | 125 |
| 32. | [dani-gavrilov/GDPerformanceView](https://github.com/dani-gavrilov/GDPerformanceView) <br/>Shows FPS, CPU usage, memory usage above the statu... | 118 |
| 33. | [HelloYeah/DraggingSort](https://github.com/HelloYeah/DraggingSort) <br/>长按拖拽排序 | 118 |
| 34. | [hackiftekhar/IQScreenRuler](https://github.com/hackiftekhar/IQScreenRuler) <br/>Screen Ruler - Pixel Perfect Screenshot Ruler | 115 |
...
| 29. | [hackiftekhar](https://github.com/hackiftekhar)  | [IQScreenRuler](https://github.com/hackiftekhar/IQScreenRuler)  (115) <br/> | 115 |
