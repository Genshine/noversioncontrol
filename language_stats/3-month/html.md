...
| 2. | [jgthms/css-reference](https://github.com/jgthms/css-reference) <br/>CSS Reference: a free visual guide to the most pop... | 2768 |
| 3. | [space10-community/conversational-form](https://github.com/space10-community/conversational-form) <br/>Turning web forms into conversations | 1839 |
| 4. | [dirtycow/dirtycow.github.io](https://github.com/dirtycow/dirtycow.github.io) <br/>Dirty COW | 1730 |
| 5. | [BoxFactura/pulltorefresh.js](https://github.com/BoxFactura/pulltorefresh.js) <br/>A quick and powerful plugin for your pull-to-refre... | 1275 |
| 6. | [pawelgrzybek/siema](https://github.com/pawelgrzybek/siema) <br/>Siema - Lightweight and simple carousel in pure Ja... | 745 |
| 7. | [ElemeFE/restc](https://github.com/ElemeFE/restc) <br/>A server-side middleware to visualize REST request... | 599 |
| 8. | [RobinLinus/socialmedia-leak](https://github.com/RobinLinus/socialmedia-leak) <br/>A demo of cross origin login detection for most ma... | 527 |
| 9. | [jaywcjlove/linux-command](https://github.com/jaywcjlove/linux-command) <br/>Linux命令大全搜索工具，内容包含Linux命令手册、详解、学习、搜集。 | 436 |
| 10. | [neveragaindottech/neveragaindottech.github.io](https://github.com/neveragaindottech/neveragaindottech.github.io) <br/>Source files for the neveragain.tech site | 343 |
| 11. | [callmelanmao/yunshare](https://github.com/callmelanmao/yunshare) <br/>百度云分享爬虫项目 | 265 |
| 12. | [rougier/from-python-to-numpy](https://github.com/rougier/from-python-to-numpy) <br/>An open-access book on numpy vectorization techniq... | 249 |
| 13. | [josephernest/talktalktalk](https://github.com/josephernest/talktalktalk) <br/>TalkTalkTalk is an easy-installable small chat roo... | 234 |
| 14. | [layui/fly](https://github.com/layui/fly) <br/>基于Layui的轻量级问答社区页面模版 | 232 |
| 15. | [samayshamdasani/enlight](https://github.com/samayshamdasani/enlight) <br/>learn to code by building projects | 218 |
| 16. | [codrops/TiltHoverEffects](https://github.com/codrops/TiltHoverEffects) <br/>Some ideas for hover effects with a fancy tilt eff... | 209 |
| 17. | [TrumpTracker/trumptracker.github.io](https://github.com/TrumpTracker/trumptracker.github.io) <br/>Open source for http://trumptracker.github.io/ | 203 |
| 18. | [AI-ON/ai-on.org](https://github.com/AI-ON/ai-on.org) <br/>AI•ON projects repository and website source. | 192 |
| 19. | [codrops/BlockRevealers](https://github.com/codrops/BlockRevealers) <br/>Ideas for revealing content in a schematic box loo... | 192 |
| 20. | [luyishisi/Anti-Anti-Spider](https://github.com/luyishisi/Anti-Anti-Spider) <br/>越来越多的网站具有反爬虫特性，有的用图片隐藏关键数据，有的使用反人类的验证码，建立反反爬虫的代码仓库... | 187 |
| 21. | [hbxeagle/rem](https://github.com/hbxeagle/rem) <br/>rem adapt | 187 |
| 22. | [tiaanduplessis/tipograf](https://github.com/tiaanduplessis/tipograf) <br/>Lightweight pure CSS typography base for your next... | 181 |
| 23. | [dhparkdh/resume-for-web-developer](https://github.com/dhparkdh/resume-for-web-developer) <br/>resume-for-web-developer | 158 |
| 24. | [notwaldorf/font-style-matcher](https://github.com/notwaldorf/font-style-matcher) <br/>⚡️🎨 Matches the x-heights and widths of two fonts | 153 |
| 25. | [jamielhf/vue](https://github.com/jamielhf/vue)  | 149 |
| 26. | [ryanhoo/Android-Proficiency-Exercise](https://github.com/ryanhoo/Android-Proficiency-Exercise) <br/>Impress me | 146 |
| 27. | [jacquerie/stop-the-bullshit](https://github.com/jacquerie/stop-the-bullshit) <br/>Blocks websites that publish fake news, and hides ... | 135 |
| 28. | [ivanceras/spongedown](https://github.com/ivanceras/spongedown) <br/>Markdown with svg bob support | 131 |
| 29. | [surikov/webaudiofont](https://github.com/surikov/webaudiofont) <br/>Web Audio Font - Soundfont for Web Audio API | 128 |
| 30. | [davestewart/javascript-state-machine](https://github.com/davestewart/javascript-state-machine) <br/>An expressive, feature-rich, event-driven JavaScri... | 116 |
| 31. | [WardCunningham/remodeling](https://github.com/WardCunningham/remodeling) <br/>The original wiki rewritten as a single page appli... | 112 |
| 32. | [gundb/gun-starter-app](https://github.com/gundb/gun-starter-app) <br/>Framework agnostic starter code for gun apps | 100 |
