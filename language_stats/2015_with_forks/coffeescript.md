...
| | Repo | Stars |
|---|---|---|
| 1. | [RocketChat/Rocket.Chat](https://github.com/RocketChat/Rocket.Chat) <br/>Have your own Slack like online chat, built with M... | S:5227 F:937 |
| 2. | [riccardoscalco/textures](https://github.com/riccardoscalco/textures) <br/>Textures.js is a JavaScript library for creating S... | S:3246 F:144 |
| 3. | [JoelBesada/activate-power-mode](https://github.com/JoelBesada/activate-power-mode) <br/>Atom package - Activate POWER MODE to write your c... | S:2127 F:235 |
| 4. | [sgentle/caniuse-cmd](https://github.com/sgentle/caniuse-cmd) <br/>Caniuse command line tool | S:909 F:25 |
| 5. | [willwhitney/hydrogen](https://github.com/willwhitney/hydrogen) <br/>Run code inline in Atom using Jupyter kernels | S:361 F:20 |
| 6. | [dmotz/natal](https://github.com/dmotz/natal) <br/>Bootstrap ClojureScript React Native apps | S:331 F:11 |
| 7. | [xixixao/Shem](https://github.com/xixixao/Shem) <br/>The compiler of the programming language Shem | S:313 F:7 |
| 8. | [rockets/rockets](https://github.com/rockets/rockets) <br/>Streams new posts and comments as they are created... | S:311 F:10 |
| 9. | [poooi/poi](https://github.com/poooi/poi) <br/>Scalable KanColle browser and tool. | S:311 F:106 |
| 10. | [yakyak/yakyak](https://github.com/yakyak/yakyak) <br/>Desktop chat client for Google Hangouts | S:289 F:34 |
| 11. | [peerlibrary/meteor-blaze-components](https://github.com/peerlibrary/meteor-blaze-components) <br/>Reusable components for Blaze | S:289 F:11 |
| 12. | [fluuuid/codedoodl.es](https://github.com/fluuuid/codedoodl.es) <br/>A curated showcase of creative coding sketches | S:271 F:37 |
| 13. | [SegmentFault/deploy-robot](https://github.com/SegmentFault/deploy-robot) <br/>GitHub 自动部署机器人 | S:236 F:35 |
| 14. | [coolwanglu/neovim-e](https://github.com/coolwanglu/neovim-e) <br/>Electron UI for Neovim | S:215 F:16 |
| 15. | [mizchi/arda](https://github.com/mizchi/arda) <br/>Meta-Flux Framework | S:206 F:13 |
| 16. | [Tomtomgo/phearjs](https://github.com/Tomtomgo/phearjs) <br/>PhearJS - render any dynamic Javascript webpage to... | S:195 F:16 |
| 17. | [KyleAMathews/typography.js](https://github.com/KyleAMathews/typography.js) <br/>An opinionated toolkit for building websites with ... | S:177 F:8 |
| 18. | [trello/iconathon](https://github.com/trello/iconathon) <br/>An icon task runner that convert Sketch files to m... | S:175 F:12 |
| 19. | [sadne/starry](https://github.com/sadne/starry) <br/>starry.so 完成一个故事 | S:162 F:37 |
| 20. | [digitalocean/heartbot](https://github.com/digitalocean/heartbot) <br/>A shot of love for your favorite chat client. | S:137 F:42 |
| 21. | [KyleAMathews/react-headroom](https://github.com/KyleAMathews/react-headroom) <br/>Hide your header until you need it | S:135 F:14 |
| 22. | [marekhrabe/messenger](https://github.com/marekhrabe/messenger) <br/>Unofficial Facebook Mesenger for Mac | S:131 F:12 |
| 23. | [iroy2000/react-reflux-boilerplate-with-webpack](https://github.com/iroy2000/react-reflux-boilerplate-with-webpack) <br/>React + Reflux + CoffeeScript + Stylus Boilerplate... | S:124 F:13 |
| 24. | [twitter-fabric/galley](https://github.com/twitter-fabric/galley) <br/>Orchestrator for local Docker containers | S:124 F:4 |
| 25. | [ccorcos/meteor-any-db](https://github.com/ccorcos/meteor-any-db) <br/>A database API for Meteor | S:123 F:10 |
| 26. | [abe33/atom-pigments](https://github.com/abe33/atom-pigments) <br/>An Atom package to display colors in project and f... | S:123 F:14 |
| 27. | [sagemathinc/smc](https://github.com/sagemathinc/smc) <br/>SageMathCloud's complete current source code repos... | S:120 F:19 |
| 28. | [heyadem/stackgrid.js](https://github.com/heyadem/stackgrid.js) <br/>A very fast and simple javascript plugin to help y... | S:107 F:12 |
| 29. | [franzenzenhofer/lsd](https://github.com/franzenzenhofer/lsd) <br/>LSD - line-square-dot: an addicting game | S:107 F:15 |
| 30. | [andischerer/atom-keyboard-localization](https://github.com/andischerer/atom-keyboard-localization) <br/>Foreign language keyboard support for atom. | S:106 F:31 |
| 31. | [Aluxian/electron-superkit](https://github.com/Aluxian/electron-superkit) <br/>:zap: An Electron starter kit with super powers. :... | S:104 F:16 |
| 32. | [k0kubun/Nocturn](https://github.com/k0kubun/Nocturn) <br/>YoruFukurou-like Twitter Client built on Electron | S:102 F:8 |
