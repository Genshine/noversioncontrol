...
| | Repo | Stars |
|---|---|---|
| 1. | [kilimchoi/engineering-blogs](https://github.com/kilimchoi/engineering-blogs) <br/>A curated list of engineering blogs | S:7187 F:747 |
| 2. | [jondot/awesome-react-native](https://github.com/jondot/awesome-react-native) <br/>An "awesome" type curated list of React Native com... | S:2312 F:236 |
| 3. | [thoughtbot/administrate](https://github.com/thoughtbot/administrate) <br/>A Rails engine that helps you put together a super... | S:2001 F:129 |
| 4. | [oa414/objc-zen-book-cn](https://github.com/oa414/objc-zen-book-cn) <br/>ObjC Zen Book 中文翻译 | S:1790 F:406 |
| 5. | [franzejr/best-ruby](https://github.com/franzejr/best-ruby) <br/>Ruby Tricks, Idiomatic Ruby, Refactorings and Best... | S:1712 F:125 |
| 6. | [rails/actioncable](https://github.com/rails/actioncable) <br/>Framework for real-time communication over websock... | S:1113 F:107 |
| 7. | [michenriksen/gitrob](https://github.com/michenriksen/gitrob) <br/>Reconnaissance tool for GitHub organizations | S:1108 F:133 |
| 8. | [madebybowtie/FlagKit](https://github.com/madebybowtie/FlagKit) <br/>Beautiful flag icons for usage in apps and on the ... | S:1034 F:51 |
| 9. | [sotownsend/BooJS](https://github.com/sotownsend/BooJS) <br/>Unix swiss army knife for headless browser javascr... | S:870 F:23 |
| 10. | [denkGroot/Spina](https://github.com/denkGroot/Spina) <br/>Spina CMS | S:735 F:91 |
| 11. | [evilsocket/bettercap](https://github.com/evilsocket/bettercap) <br/>A complete, modular, portable and easily extensibl... | S:724 F:102 |
| 12. | [TheBlasfem/ruby-patterns](https://github.com/TheBlasfem/ruby-patterns) <br/>Examples of Patterns in Ruby | S:703 F:57 |
| 13. | [fastlane/spaceship](https://github.com/fastlane/spaceship) <br/>Ruby library to access the Apple Dev Center and iT... | S:644 F:85 |
| 14. | [igorkasyanchuk/rails_db](https://github.com/igorkasyanchuk/rails_db) <br/>Rails Database Viewer and SQL Query Runner | S:639 F:35 |
| 15. | [fastlane/gym](https://github.com/fastlane/gym) <br/>Building your iOS apps has never been easier | S:601 F:47 |
| 16. | [codeclimate/codeclimate](https://github.com/codeclimate/codeclimate) <br/>Code Climate CLI | S:588 F:51 |
| 17. | [vdaubry/github-awards](https://github.com/vdaubry/github-awards) <br/>Discover your ranking on github : | S:575 F:53 |
| 18. | [solidusio/solidus](https://github.com/solidusio/solidus) <br/>Solidus, Rails eCommerce System | S:570 F:135 |
| 19. | [janko-m/shrine](https://github.com/janko-m/shrine) <br/>File upload toolkit for Ruby | S:567 F:16 |
| 20. | [ko1/pretty_backtrace](https://github.com/ko1/pretty_backtrace) <br/>Pretty your exception backtrace. | S:557 F:20 |
| 21. | [shakacode/react_on_rails](https://github.com/shakacode/react_on_rails) <br/>Integration of React + Webpack + Rails to build Un... | S:548 F:47 |
| 22. | [MadRabbit/ruby-fighter](https://github.com/MadRabbit/ruby-fighter) <br/>Street Fighter II in Ruby! | S:543 F:51 |
| 23. | [SUSE/Portus](https://github.com/SUSE/Portus) <br/>Authorization service and frontend for Docker regi... | S:520 F:72 |
| 24. | [cesarferreira/dryrun](https://github.com/cesarferreira/dryrun) <br/>:coffee: Try the demo project of any Android Libra... | S:518 F:43 |
| 25. | [rmosolgo/graphql-ruby](https://github.com/rmosolgo/graphql-ruby) <br/>Ruby implementation of Facebook's GraphQL | S:517 F:41 |
| 26. | [kontena/kontena](https://github.com/kontena/kontena) <br/>Container platform built to maximize developer hap... | S:515 F:31 |
| 27. | [vigetlabs/gulp-rails-pipeline](https://github.com/vigetlabs/gulp-rails-pipeline) <br/>Ditch the Rails Asset Pipeline and roll your own w... | S:508 F:55 |
| 28. | [guipdutra/awesome-geek-podcasts](https://github.com/guipdutra/awesome-geek-podcasts) <br/>A curated list of podcasts we like to listen to. | S:499 F:85 |
| 29. | [DamirSvrtan/fasterer](https://github.com/DamirSvrtan/fasterer) <br/>Don't make your Rubies go fast. Make them go faste... | S:498 F:22 |
| 30. | [jsomers/git-game](https://github.com/jsomers/git-game) <br/>The git committer guessing game! | S:437 F:26 |
| 31. | [neonichu/xcode-install](https://github.com/neonichu/xcode-install) <br/>Install and update your Xcodes. | S:431 F:33 |
| 32. | [zetachang/react.rb](https://github.com/zetachang/react.rb) <br/>Opal Ruby wrapper of React.js library. | S:427 F:30 |
| 33. | [ankane/the-ultimate-guide-to-ruby-timeouts](https://github.com/ankane/the-ultimate-guide-to-ruby-timeouts) <br/>:clock4: | S:408 F:16 |
...
| 34. | [square](https://github.com/square)  | [leakcanary](https://github.com/square/leakcanary)  (6794) <br/>[sqlbrite](https://github.com/square/sqlbrite)  (1973) <br/>[Valet](https://github.com/square/Valet)  (1459) <br/>[keywhiz](https://github.com/square/keywhiz)  (1220) <br/>[spacecommander](https://github.com/square/spacecommander)  (500) <br/>[haha](https://github.com/square/haha)  (363) <br/>[field-kit](https://github.com/square/field-kit)  (354) <br/>[certstrap](https://github.com/square/certstrap)  (308) <br/>[duktape-android](https://github.com/square/duktape-android)  (198) <br/>[inspect](https://github.com/square/inspect)  (159) <br/>[git-fastclone](https://github.com/square/git-fastclone)  (129) <br/> | 129 |
