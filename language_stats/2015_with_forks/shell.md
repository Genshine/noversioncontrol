...
| | Repo | Stars |
|---|---|---|
| 1. | [p8952/bocker](https://github.com/p8952/bocker) <br/>Docker implemented in around 100 lines of bash | S:2836 F:146 |
| 2. | [gliderlabs/docker-alpine](https://github.com/gliderlabs/docker-alpine) <br/>Alpine Linux Docker image. Win at minimalism! | S:2442 F:100 |
| 3. | [michaeldfallen/git-radar](https://github.com/michaeldfallen/git-radar) <br/>A heads up display for git | S:2379 F:70 |
| 4. | [jamesob/desk](https://github.com/jamesob/desk) <br/>A lightweight workspace manager for the shell | S:1757 F:55 |
| 5. | [ryanmjacobs/c](https://github.com/ryanmjacobs/c) <br/>Compile and execute C "scripts" in one go! | S:1307 F:88 |
| 6. | [qw3rtman/gg](https://github.com/qw3rtman/gg) <br/>:candy: Git Goodies: At-A-Glance, Efficient, and A... | S:1293 F:43 |
| 7. | [qw3rtman/git-fire](https://github.com/qw3rtman/git-fire) <br/>:fire: Save Your Code in an Emergency | S:1157 F:42 |
| 8. | [drduh/pwd.sh](https://github.com/drduh/pwd.sh) <br/>Script to manage passwords in an encrypted file us... | S:1079 F:88 |
| 9. | [docker/docker-bench-security](https://github.com/docker/docker-bench-security) <br/>The Docker Bench for Security is a script that che... | S:1031 F:91 |
| 10. | [rauchg/wifi-password](https://github.com/rauchg/wifi-password) <br/>Get the password of the wifi you're on (bash) | S:941 F:55 |
| 11. | [Juude/droidReverse](https://github.com/Juude/droidReverse) <br/>reverse engineering tools for android（android 逆向工程... | S:838 F:142 |
| 12. | [DreaminginCodeZH/MaterialColdStart](https://github.com/DreaminginCodeZH/MaterialColdStart) <br/>Utilize the window background during cold start ti... | S:737 F:63 |
| 13. | [brikis98/docker-osx-dev](https://github.com/brikis98/docker-osx-dev) <br/>A productive development environment with Docker o... | S:699 F:63 |
| 14. | [zhengxiaopeng/android-dev-bookmarks](https://github.com/zhengxiaopeng/android-dev-bookmarks) <br/>Android Dev Bookmarks(ADB) - Android 开发者站点资源 | S:676 F:188 |
| 15. | [mrowa44/emojify](https://github.com/mrowa44/emojify) <br/>Emoji on the command line :scream: | S:577 F:21 |
| 16. | [taviso/ctypes.sh](https://github.com/taviso/ctypes.sh) <br/>A foreign function interface for bash. | S:573 F:30 |
| 17. | [github/scripts-to-rule-them-all](https://github.com/github/scripts-to-rule-them-all) <br/>Scripts to Rule Them All | S:553 F:27 |
| 18. | [aerofs/gockerize](https://github.com/aerofs/gockerize) <br/>Package golang service into minimal docker contain... | S:547 F:12 |
| 19. | [Azure/azure-quickstart-templates](https://github.com/Azure/azure-quickstart-templates) <br/>Azure Quickstart Templates | S:528 F:698 |
| 20. | [oh-my-fish/oh-my-fish](https://github.com/oh-my-fish/oh-my-fish) <br/>The Fishshell Framework. | S:523 F:63 |
| 21. | [qw3rtman/p](https://github.com/qw3rtman/p) <br/>:snake: Python Version Management Made Simple | S:512 F:16 |
| 22. | [opengapps/opengapps](https://github.com/opengapps/opengapps) <br/>The main repository of the Open GApps Project | S:504 F:98 |
| 23. | [zardus/ctf-tools](https://github.com/zardus/ctf-tools) <br/>Some setup scripts for security research tools. | S:457 F:127 |
| 24. | [lukas2511/letsencrypt.sh](https://github.com/lukas2511/letsencrypt.sh) <br/>letsencrypt/acme client implemented as a shell-scr... | S:451 F:39 |
| 25. | [zakjan/cert-chain-resolver](https://github.com/zakjan/cert-chain-resolver) <br/>SSL certificate chain resolver | S:422 F:24 |
| 26. | [awslabs/git-secrets](https://github.com/awslabs/git-secrets) <br/>Prevents you from committing secrets and credentia... | S:400 F:6 |
| 27. | [paulirish/git-open](https://github.com/paulirish/git-open) <br/>Type `git open` to open the GitHub page or website... | S:385 F:37 |
| 28. | [HIT-Alibaba/interview](https://github.com/HIT-Alibaba/interview) <br/>笔试面试知识整理 | S:361 F:74 |
| 29. | [nodesocket/jsonlite](https://github.com/nodesocket/jsonlite) <br/>A simple, self-contained, serverless, zero-configu... | S:356 F:11 |
| 30. | [eivind88/prm](https://github.com/eivind88/prm) <br/>A minimal project manager for the terminal. | S:325 F:17 |
| 31. | [VISIONAI/clouddream](https://github.com/VISIONAI/clouddream) <br/>Deepdreaming in the clouds: A Dockerized deepdream... | S:316 F:53 |
| 32. | [neologd/mecab-ipadic-neologd](https://github.com/neologd/mecab-ipadic-neologd) <br/>Neologism dictionary based on the language resourc... | S:310 F:25 |
| 33. | [digitalocean/do_user_scripts](https://github.com/digitalocean/do_user_scripts)  | S:305 F:75 |
