...
| | Repo | Stars |
|---|---|---|
| 1. | [ConnorAtherton/loaders.css](https://github.com/ConnorAtherton/loaders.css) <br/>Delightful, performance-focused pure css loading a... | S:5574 F:587 |
| 2. | [primer/primer](https://github.com/primer/primer) <br/>The base coat of GitHub. Our internal CSS toolkit ... | S:4491 F:310 |
| 3. | [connors/photon](https://github.com/connors/photon) <br/>The fastest way to build beautiful Electron apps u... | S:4122 F:141 |
| 4. | [18F/web-design-standards](https://github.com/18F/web-design-standards) <br/>Open source UI components and visual style guide f... | S:2725 F:297 |
| 5. | [horst3180/Arc-theme](https://github.com/horst3180/Arc-theme) <br/>A flat theme with transparent elements | S:2383 F:119 |
| 6. | [HubPress/hubpress.io](https://github.com/HubPress/hubpress.io) <br/>A web application to build your blog on GitHub | S:2163 F:1919 |
| 7. | [ant-design/ant-design](https://github.com/ant-design/ant-design) <br/>A design language | S:2040 F:319 |
| 8. | [OfficeDev/Office-UI-Fabric](https://github.com/OfficeDev/Office-UI-Fabric) <br/>The front-end framework for building experiences f... | S:1813 F:215 |
| 9. | [henriquea/minigrid](https://github.com/henriquea/minigrid) <br/>Minimal 2kb zero dependency cascading grid layout | S:1548 F:92 |
| 10. | [gopatrik/space.js](https://github.com/gopatrik/space.js) <br/> A HTML-driven JavaScript-library for narrative 3D... | S:1389 F:133 |
| 11. | [markdregan/Bayesian-Modelling-in-Python](https://github.com/markdregan/Bayesian-Modelling-in-Python) <br/>A python tutorial on bayesian modeling techniques ... | S:1217 F:92 |
| 12. | [anmoljagetia/Flatabulous](https://github.com/anmoljagetia/Flatabulous) <br/>This is a Flat theme for Ubuntu and other Gnome ba... | S:1156 F:72 |
| 13. | [ctfs/write-ups-2015](https://github.com/ctfs/write-ups-2015) <br/>Wiki-like CTF write-ups repository, maintained by ... | S:1021 F:425 |
| 14. | [tylingsoft/markdown-plus](https://github.com/tylingsoft/markdown-plus) <br/>Markdown Plus ("M+" or "mdp" for short) is a versa... | S:967 F:131 |
| 15. | [LeaVerou/stretchy](https://github.com/LeaVerou/stretchy) <br/>Form element autosizing, the way it should be. | S:939 F:53 |
| 16. | [mblode/marx](https://github.com/mblode/marx) <br/>The stylish CSS reset. | S:900 F:60 |
| 17. | [FrontendMasters/front-end-handbook](https://github.com/FrontendMasters/front-end-handbook) <br/>The resources and tools for learning about the pra... | S:876 F:122 |
| 18. | [lmgonzalves/segment](https://github.com/lmgonzalves/segment) <br/>A little JavaScript class (without dependencies) t... | S:850 F:43 |
| 19. | [maxogden/monu](https://github.com/maxogden/monu) <br/>menubar process monitor mac app [ALPHA] | S:819 F:43 |
| 20. | [anicollection/anicollection](https://github.com/anicollection/anicollection) <br/>The easiest way to find, use and share animations.... | S:778 F:45 |
| 21. | [losvedir/ephemeral2](https://github.com/losvedir/ephemeral2) <br/>Ephemeral P2P over websockets, Phoenix/Elixir. | S:753 F:51 |
| 22. | [jaicab/localFont](https://github.com/jaicab/localFont) <br/>Implement localStorage web font caching in seconds | S:752 F:23 |
| 23. | [mblode/burger](https://github.com/mblode/burger) <br/>Burger - The minimal hamburger menu with fullscree... | S:740 F:39 |
| 24. | [ben-eb/cssnano](https://github.com/ben-eb/cssnano) <br/>A modular minifier, built on top of the PostCSS ec... | S:696 F:26 |
| 25. | [yegor256/tacit](https://github.com/yegor256/tacit) <br/>CSS Framework for Dummies, Without Classes | S:692 F:35 |
| 26. | [wintercn/dog-fucked-zhihu](https://github.com/wintercn/dog-fucked-zhihu) <br/>退出知乎好帮手——狗日的知乎，备份自己的答案，取消所有点赞，批量替换所有答案 | S:613 F:114 |
| 27. | [codrops/TextInputEffects](https://github.com/codrops/TextInputEffects) <br/>Simple styles and effects for enhancing text input... | S:583 F:111 |
| 28. | [cmaddux/littlebox](https://github.com/cmaddux/littlebox) <br/>Super simple to implement, CSS-only icons. | S:552 F:31 |
| 29. | [qrohlf/trianglify-generator](https://github.com/qrohlf/trianglify-generator) <br/>no-coding-required triangle pattern generator. wor... | S:542 F:43 |
| 30. | [GoogleChrome/big-rig](https://github.com/GoogleChrome/big-rig) <br/>A proof-of-concept Performance Dashboard, CLI and ... | S:531 F:25 |
| 31. | [sconstantinides/FormButtons](https://github.com/sconstantinides/FormButtons) <br/>Forms within buttons, oh my! | S:505 F:35 |
| 32. | [LukyVj/Colorify.js](https://github.com/LukyVj/Colorify.js) <br/>The simple, customizable, tiny javascript color ex... | S:479 F:19 |
| 33. | [RedHatBrand/overpass](https://github.com/RedHatBrand/overpass) <br/>Overpass open source web font family — Sponsored b... | S:474 F:19 |
| 34. | [shlomi-noach/awesome-mysql](https://github.com/shlomi-noach/awesome-mysql) <br/>A curated list of awesome MySQL software, librarie... | S:441 F:72 |
...
| 71. | [AndrewBelt/WiTeX](https://github.com/AndrewBelt/WiTeX) <br/>If Donald Knuth had designed Wikipedia | S:274 F:19 |
...
| 108. | [kennethormandy/utility-opentype](https://github.com/kennethormandy/utility-opentype) <br/>Simple, CSS utility classes for advanced typograph... | S:197 F:5 |
...
| 145. | [sachinchoolur/angular-flash](https://github.com/sachinchoolur/angular-flash) <br/>A simple lightweight flash message module for angu... | S:140 F:28 |
...
| 182. | [pidcodes/pidcodes.github.com](https://github.com/pidcodes/pidcodes.github.com) <br/>Website for pid.codes | S:103 F:192 |
...
| 23. | [diafygi](https://github.com/diafygi)  | [webrtc-ips](https://github.com/diafygi/webrtc-ips)  (1884) <br/>[acme-tiny](https://github.com/diafygi/acme-tiny)  (1739) <br/>[letsencrypt-nosudo](https://github.com/diafygi/letsencrypt-nosudo)  (658) <br/>[gethttpsforfree](https://github.com/diafygi/gethttpsforfree)  (576) <br/>[gnu-pricing](https://github.com/diafygi/gnu-pricing)  (440) <br/>[webcrypto-examples](https://github.com/diafygi/webcrypto-examples)  (360) <br/> | 440 |
...
| 55. | [colourgarden](https://github.com/colourgarden)  | [avalanche](https://github.com/colourgarden/avalanche)  (250) <br/> | 250 |
...
| 24. | [IronSummitMedia](https://github.com/IronSummitMedia)  | [startbootstrap-creative](https://github.com/IronSummitMedia/startbootstrap-creative)  (302) <br/> | 302 |
