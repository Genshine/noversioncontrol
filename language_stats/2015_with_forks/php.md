...
| | Repo | Stars |
|---|---|---|
| 1. | [phanan/koel](https://github.com/phanan/koel) <br/>A personal music streaming server that works. | S:4927 F:375 |
| 2. | [laravel/lumen](https://github.com/laravel/lumen)  | S:3238 F:334 |
| 3. | [phptodayorg/php-must-watch](https://github.com/phptodayorg/php-must-watch) <br/>list of interesting conference talks and videos on... | S:1893 F:139 |
| 4. | [hmlb/phpunit-vw](https://github.com/hmlb/phpunit-vw) <br/>VW PHPUnit extension makes your failing test cases... | S:1587 F:41 |
| 5. | [delight-im/FreeGeoDB](https://github.com/delight-im/FreeGeoDB) <br/>Free database of geographic place names and corres... | S:1515 F:118 |
| 6. | [paragonie/awesome-appsec](https://github.com/paragonie/awesome-appsec) <br/>A curated list of resources for learning about app... | S:1373 F:79 |
| 7. | [overtrue/wechat](https://github.com/overtrue/wechat) <br/>可能是目前最优雅的微信公众平台 SDK 了 | S:1287 F:469 |
| 8. | [tencent-php/tsf](https://github.com/tencent-php/tsf) <br/>coroutine and Swoole based php server framework in... | S:1121 F:292 |
| 9. | [laravel/spark](https://github.com/laravel/spark)  | S:1086 F:158 |
| 10. | [rlerdorf/php7dev](https://github.com/rlerdorf/php7dev) <br/>Documentation for the php7dev Vagrant box image | S:893 F:100 |
| 11. | [s4n7h0/xvwa](https://github.com/s4n7h0/xvwa) <br/>XVWA is a badly coded web application written in P... | S:881 F:86 |
| 12. | [rappasoft/laravel-5-boilerplate](https://github.com/rappasoft/laravel-5-boilerplate) <br/>A Laravel 5 Boilerplate Project | S:789 F:226 |
| 13. | [laracasts/Laravel-5-Generators-Extended](https://github.com/laracasts/Laravel-5-Generators-Extended) <br/>This package extends the core file generators that... | S:785 F:136 |
| 14. | [ErikvdVen/php-gif](https://github.com/ErikvdVen/php-gif)  | S:751 F:40 |
| 15. | [javiereguiluz/EasyAdminBundle](https://github.com/javiereguiluz/EasyAdminBundle) <br/>The new (and simple) admin generator for Symfony a... | S:730 F:113 |
| 16. | [gherkins/regexpbuilderphp](https://github.com/gherkins/regexpbuilderphp) <br/>human-readable regular expressions for PHP 5.3+ | S:719 F:33 |
| 17. | [jadjoubran/laravel5-angular-material-starter](https://github.com/jadjoubran/laravel5-angular-material-starter) <br/>Get started with Laravel 5 and Angular (material) | S:718 F:158 |
| 18. | [etsy/phan](https://github.com/etsy/phan) <br/>Static analyzer for PHP | S:671 F:52 |
| 19. | [johnlui/Learn-Laravel-5](https://github.com/johnlui/Learn-Laravel-5) <br/>Laravel 5 系列入门教程 代码示例 | S:646 F:131 |
| 20. | [phpro/grumphp](https://github.com/phpro/grumphp) <br/>A PHP code-quality tool | S:616 F:38 |
| 21. | [ipfspics/server](https://github.com/ipfspics/server) <br/>Distributed image hosting | S:612 F:12 |
| 22. | [romanbican/roles](https://github.com/romanbican/roles) <br/>Powerful package for handling roles and permission... | S:602 F:112 |
| 23. | [mitulgolakiya/laravel-api-generator](https://github.com/mitulgolakiya/laravel-api-generator) <br/>Laravel API/Scaffold/CRUD Generator including Cont... | S:556 F:128 |
| 24. | [mdkholy/dashbrew](https://github.com/mdkholy/dashbrew) <br/>Dashbrew is a Vagrant build that aims to provide a... | S:543 F:46 |
| 25. | [AutumnsWind/Front-end-questions-to-the-interview-stage](https://github.com/AutumnsWind/Front-end-questions-to-the-interview-stage) <br/>:snail:最全前端开发面试问题及答案整理 | S:535 F:116 |
| 26. | [api-platform/api-platform](https://github.com/api-platform/api-platform) <br/>API-first web framework on top of Symfony with JSO... | S:521 F:37 |
| 27. | [Obox/layerswp](https://github.com/Obox/layerswp) <br/>Layers WordPress theme by Obox | S:521 F:138 |
| 28. | [Pr0x13/iDict](https://github.com/Pr0x13/iDict) <br/>iCloud Apple iD BruteForcer | S:485 F:329 |
| 29. | [box/spout](https://github.com/box/spout) <br/>Read and write spreadsheet files (CSV, XLSX and OD... | S:468 F:43 |
| 30. | [phpfunct/funct](https://github.com/phpfunct/funct) <br/>A PHP library with commonly used code blocks | S:468 F:44 |
| 31. | [wealthbot-io/wealthbot](https://github.com/wealthbot-io/wealthbot) <br/>Use wealthbot.io to easily setup your own wealth m... | S:464 F:56 |
| 32. | [spatie/laravel-medialibrary](https://github.com/spatie/laravel-medialibrary) <br/>Associate files with Eloquent models | S:459 F:49 |
| 33. | [php-school/cli-menu](https://github.com/php-school/cli-menu) <br/>Build beautiful PHP CLI menus. Simple yet Powerful... | S:448 F:20 |
