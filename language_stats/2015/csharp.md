...
| | Repo | Stars |
|---|---|---|
| 1. | [dotnet/coreclr](https://github.com/dotnet/coreclr) <br/>This repo contains the .NET Core runtime, called C... | 5610 |
| 2. | [dotnet/roslyn](https://github.com/dotnet/roslyn) <br/>The .NET Compiler Platform ("Roslyn") provides ope... | 4132 |
| 3. | [01org/acat](https://github.com/01org/acat) <br/>Assistive Context-Aware Toolkit | 2463 |
| 4. | [Microsoft/msbuild](https://github.com/Microsoft/msbuild) <br/>The Microsoft Build Engine (MSBuild) is the build... | 2415 |
| 5. | [KeenSoftwareHouse/SpaceEngineers](https://github.com/KeenSoftwareHouse/SpaceEngineers)  | 1948 |
| 6. | [OpenLiveWriter/OpenLiveWriter](https://github.com/OpenLiveWriter/OpenLiveWriter) <br/>An open source fork of Windows Live Writer | 1581 |
| 7. | [Microsoft/nodejstools](https://github.com/Microsoft/nodejstools) <br/>Node.js Tools for Visual Studio | 973 |
| 8. | [ButchersBoy/MaterialDesignInXamlToolkit](https://github.com/ButchersBoy/MaterialDesignInXamlToolkit) <br/>Google's Material Design in XAML & WPF, for C# & V... | 808 |
| 9. | [Microsoft/PTVS](https://github.com/Microsoft/PTVS) <br/>Python Tools for Visual Studio | 784 |
| 10. | [Nummer/Destroy-Windows-10-Spying](https://github.com/Nummer/Destroy-Windows-10-Spying) <br/>Remove windows 10 spying tool | 712 |
| 11. | [utkusen/hidden-tear](https://github.com/utkusen/hidden-tear) <br/>an open source ransomware-like file crypter kit | 695 |
| 12. | [Windows-XAML/Template10](https://github.com/Windows-XAML/Template10) <br/>Making Windows 10 apps awesome | 569 |
| 13. | [telerik/JustDecompileEngine](https://github.com/telerik/JustDecompileEngine) <br/>The decompilation engine of | 568 |
...
| 21. | [PFCKrutonium/Windows-10-Login-Background-Changer](https://github.com/PFCKrutonium/Windows-10-Login-Background-Changer) <br/>Changes the Windows 10 Login Screen Background | 458 |
| 22. | [RolandPheasant/TailBlazer](https://github.com/RolandPheasant/TailBlazer) <br/>A modern file tail utility based on RX.Net | 441 |
| 23. | [i-saint/Unity5Effects](https://github.com/i-saint/Unity5Effects)  | 425 |
| 24. | [Microsoft/CodeContracts](https://github.com/Microsoft/CodeContracts) <br/>Source code for the CodeContracts tools for .NET | 387 |
| 25. | [EWSoftware/SHFB](https://github.com/EWSoftware/SHFB) <br/>Sandcastle Help File Builder (SHFB).  A standalone... | 375 |
| 26. | [github/VisualStudio](https://github.com/github/VisualStudio) <br/>GitHub Extension for Visual Studio | 345 |
| 27. | [bitdust/EarthLiveSharp](https://github.com/bitdust/EarthLiveSharp) <br/>live view of earth from space | 334 |
| 28. | [yuvaltz/Granular](https://github.com/yuvaltz/Granular) <br/>WPF for JavaScript | 331 |
| 29. | [x360ce/x360ce](https://github.com/x360ce/x360ce) <br/>Primary repository for the x360ce library, front-e... | 317 |
| 30. | [Microsoft/Microsoft.IO.RecyclableMemoryStream](https://github.com/Microsoft/Microsoft.IO.RecyclableMemoryStream) <br/>A library to provide pooling for .NET MemoryStream... | 317 |
| 31. | [nefarius/ScpServer](https://github.com/nefarius/ScpServer) <br/>Windows Driver and XInput Wrapper for Sony DualSho... | 295 |
| 32. | [Microsoft/Git-Credential-Manager-for-Windows](https://github.com/Microsoft/Git-Credential-Manager-for-Windows) <br/>Secure Git credential storage for Windows. | 287 |
| 33. | [filoe/cscore](https://github.com/filoe/cscore) <br/>An advanced audio library, written in C#. Provides... | 282 |
| 34. | [Microsoft/GraphView](https://github.com/Microsoft/GraphView) <br/>GraphView is a DLL library that enables users to u... | 282 |
...
| 71. | [sirWest/AudioSwitch](https://github.com/sirWest/AudioSwitch) <br/>Switch between default audio input or output + cha... | 163 |
...
| 108. | [i66soft/osharp](https://github.com/i66soft/osharp) <br/>osharp framework version 3.x | 123 |
...
| 20. | [ElevenPaths](https://github.com/ElevenPaths)  | [EvilFOCA](https://github.com/ElevenPaths/EvilFOCA)  (222) <br/> | 222 |
| 21. | [vsco](https://github.com/vsco)  | [keys](https://github.com/vsco/keys)  (222) <br/> | 222 |
...
| Haskell | [Repos](https://github.com/donnemartin/gh-stats/blob/master/language_stats/2015/haskell.md#most-starred-repos-haskell) - [Users](h