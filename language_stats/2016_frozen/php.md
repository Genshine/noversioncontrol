...
| | Repo | Stars |
|---|---|---|
| 1. | [the-control-group/voyager](https://github.com/the-control-group/voyager) <br/>Voyager - The Missing Laravel Admin | 1846 |
| 2. | [helloqingfeng/Awsome-Front-End-learning-resource](https://github.com/helloqingfeng/Awsome-Front-End-learning-resource) <br/>:octocat:GitHub最全的前端资源汇总仓库（包括前端学习、开发资源、求职面试等） | 1715 |
| 3. | [SimpleRegex/SRL-PHP](https://github.com/SimpleRegex/SRL-PHP) <br/>Simple Regex Language | 1633 |
| 4. | [docker/labs](https://github.com/docker/labs) <br/>This is a collection of tutorials for learning how... | 1560 |
| 5. | [gabrielrcouto/php-gui](https://github.com/gabrielrcouto/php-gui) <br/>Extensionless PHP Graphic User Interface library | 1539 |
| 6. | [bartblaze/PHP-backdoors](https://github.com/bartblaze/PHP-backdoors) <br/>A collection of PHP backdoors. For educational or ... | 1290 |
| 7. | [renatomarinho/laravel-gitscrum](https://github.com/renatomarinho/laravel-gitscrum) <br/>Laravel GitScrum is a free application to help dev... | 1186 |
| 8. | [InfyOmLabs/laravel-generator](https://github.com/InfyOmLabs/laravel-generator) <br/>InfyOm Laravel Generator - API, Scaffold, CRUD Lar... | 1150 |
| 9. | [nextcloud/server](https://github.com/nextcloud/server) <br/>☁️ Nextcloud server | 1145 |
| 10. | [gabrielrcouto/php-terminal-gameboy-emulator](https://github.com/gabrielrcouto/php-terminal-gameboy-emulator) <br/>A PHP Terminal GameBoy Emulator | 1136 |
| 11. | [mpociot/botman](https://github.com/mpociot/botman) <br/>A framework agnostic PHP library to build chat bot... | 1126 |
| 12. | [unicodeveloper/laravel-hackathon-starter](https://github.com/unicodeveloper/laravel-hackathon-starter) <br/>:computer: :octocat: A hackathon/MVP boilerplate f... | 1115 |
| 13. | [php-ai/php-ml](https://github.com/php-ai/php-ml) <br/>PHP-ML - Machine Learning library for PHP | 1073 |
| 14. | [cnvs/canvas](https://github.com/cnvs/canvas) <br/>Simple, Powerful Blog Publishing Platform | 928 |
| 15. | [Vuedo/vuedo](https://github.com/Vuedo/vuedo) <br/>Vuedo is a blog platform, built with Laravel and V... | 898 |
| 16. | [andrew-worsfold/tailor](https://github.com/andrew-worsfold/tailor) <br/>Build beautiful page layouts quickly and easily us... | 890 |
| 17. | [summerblue/phphub5](https://github.com/summerblue/phphub5) <br/>PHPHub Ver 5 is a Forum project Powered by Laravel... | 781 |
| 18. | [teamtnt/tntsearch](https://github.com/teamtnt/tntsearch) <br/>A fully featured full text search engine written i... | 750 |
| 19. | [rinvex/country](https://github.com/rinvex/country) <br/>Rinvex Country is a simple and lightweight package... | 705 |
| 20. | [lavary/crunz](https://github.com/lavary/crunz) <br/>A PHP-based job scheduler | 662 |
| 21. | [laravel/valet](https://github.com/laravel/valet)  | 657 |
| 22. | [mpociot/laravel-apidoc-generator](https://github.com/mpociot/laravel-apidoc-generator) <br/>Laravel API Documentation Generator | 626 |
| 23. | [markrogoyski/math-php](https://github.com/markrogoyski/math-php) <br/>Powerful modern math library for PHP: Features des... | 625 |
| 24. | [ngfw/Recipe](https://github.com/ngfw/Recipe) <br/>Collection of PHP Functions | 625 |
| 25. | [orangetw/My-CTF-Web-Challenges](https://github.com/orangetw/My-CTF-Web-Challenges) <br/>Collection of CTF Web challenges I made | 620 |
| 26. | [Leafpub/leafpub](https://github.com/Leafpub/leafpub) <br/>Simple, beautiful, open source publishing. | 605 |
| 27. | [daylerees/scientist](https://github.com/daylerees/scientist) <br/>A PHP experimentation library inspired by Github's... | 598 |
| 28. | [YABhq/Laracogs](https://github.com/YABhq/Laracogs) <br/>Prepare your Laravel apps incredibly fast, with va... | 596 |
| 29. | [etsy/411](https://github.com/etsy/411) <br/>An Alert Management Web Application | 583 |
| 30. | [Hifone/Hifone](https://github.com/Hifone/Hifone) <br/>A free, open-source, self-hosted forum software ba... | 576 |
| 31. | [themsaid/laravel-langman](https://github.com/themsaid/laravel-langman) <br/>Language files manager in your artisan console. | 570 |
| 32. | [MenaraSolutions/geographer](https://github.com/MenaraSolutions/geographer) <br/>PHP library that knows how countries and cities ar... | 567 |
| 33. | [phpstan/phpstan](https://github.com/phpstan/phpstan) <br/>PHP Static Analysis Tool - discover bugs in your c... | 560 |
...
| 35. | [santigarcor](https://github.com/santigarcor)  | [laratrust](https://github.com/santigarcor/laratrust)  (230) <br/> | 230 |
...
| 72. | [svenluijten](https://github.com/svenluijten)  | [artisan-view](https://github.com/svenluijten/artisan-view)  (146) <br/> | 146 |
...
| 29. | [ScriptFUSION](https://github.com/ScriptFUSION)  | [Porter](https://github.com/ScriptFUSION/Porter)  (299) <br/> | 299 |
...
| 66. | [Freemius](https://github.com/Freemius)  | [IncludeWP](https://github.com/Freemius/IncludeWP)  (115) <br/> | 115 |
