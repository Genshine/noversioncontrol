...
| | Repo | Stars |
|---|---|---|
| 1. | [CRYTEK-CRYENGINE/CRYENGINE](https://github.com/CRYTEK-CRYENGINE/CRYENGINE) <br/>CRYENGINE is a powerful real-time game development... | 6465 |
| 2. | [facebookresearch/fastText](https://github.com/facebookresearch/fastText) <br/>Library for fast text representation and classific... | 6391 |
| 3. | [Tencent/mars](https://github.com/Tencent/mars) <br/>Mars is a cross-platform network component  develo... | 5758 |
| 4. | [uWebSockets/uWebSockets](https://github.com/uWebSockets/uWebSockets) <br/>Highly scalable cross-platform WebSocket & HTTP li... | 4691 |
| 5. | [PaddlePaddle/Paddle](https://github.com/PaddlePaddle/Paddle) <br/>PArallel Distributed Deep LEarning | 4041 |
| 6. | [dropbox/lepton](https://github.com/dropbox/lepton) <br/>Lepton is a tool and file format for losslessly co... | 3869 |
| 7. | [amznlabs/amazon-dsstne](https://github.com/amznlabs/amazon-dsstne) <br/>Deep Scalable Sparse Tensor Network Engine (DSSTNE... | 3504 |
| 8. | [facebook/redex](https://github.com/facebook/redex) <br/>A bytecode optimizer for Android apps | 3270 |
| 9. | [kyleneideck/BackgroundMusic](https://github.com/kyleneideck/BackgroundMusic) <br/>Background Music, a macOS audio utility: automatic... | 2921 |
| 10. | [tekezo/Karabiner-Elements](https://github.com/tekezo/Karabiner-Elements) <br/>The next generation Karabiner for macOS Sierra | 2683 |
| 11. | [Croteam-official/Serious-Engine](https://github.com/Croteam-official/Serious-Engine) <br/>An open source version of a game engine developed ... | 2327 |
| 12. | [googlecartographer/cartographer](https://github.com/googlecartographer/cartographer) <br/>Cartographer is a system that provides real-time s... | 2220 |
| 13. | [yandex/ClickHouse](https://github.com/yandex/ClickHouse) <br/>ClickHouse is a free analytic DBMS for big data. | 1877 |
| 14. | [Microsoft/LightGBM](https://github.com/Microsoft/LightGBM) <br/>A fast, distributed, high performance gradient boo... | 1706 |
| 15. | [ryanjay0/miles-deep](https://github.com/ryanjay0/miles-deep) <br/>Deep Learning Porn Video Classifier/Editor with Ca... | 1677 |
| 16. | [udacity/self-driving-car](https://github.com/udacity/self-driving-car) <br/>The Udacity open source self-driving car project | 1674 |
| 17. | [runner365/LiveVideoCoreSDK](https://github.com/runner365/LiveVideoCoreSDK)  | 1659 |
| 18. | [opentoonz/opentoonz](https://github.com/opentoonz/opentoonz) <br/>OpenToonz - An open-source full-featured 2D animat... | 1624 |
| 19. | [alibaba/AliSQL](https://github.com/alibaba/AliSQL) <br/>AliSQL is a MySQL branch originated from Alibaba G... | 1564 |
| 20. | [tencent-wechat/phxsql](https://github.com/tencent-wechat/phxsql) <br/>A high availability MySQL cluster that guarantees ... | 1484 |
| 21. | [facebook/Surround360](https://github.com/facebook/Surround360) <br/>Surround360 is Facebook's open source hardware and... | 1367 |
| 22. | [LibreVR/Revive](https://github.com/LibreVR/Revive) <br/>Play Oculus-exclusive games on the HTC Vive, scrol... | 1327 |
| 23. | [seetaface/SeetaFaceEngine](https://github.com/seetaface/SeetaFaceEngine)  | 1289 |
| 24. | [google/ion](https://github.com/google/ion) <br/>Ion | 1270 |
| 25. | [AnyRTC/AnyRTC-RTMP](https://github.com/AnyRTC/AnyRTC-RTMP) <br/>RTMP 推流器，RTMP(HLS)秒开播放器，跨平台（Win,IOS,Android）开源代码 | 1223 |
| 26. | [koth/kcws](https://github.com/koth/kcws) <br/>Deep Learning Chinese Word Segment | 1178 |
| 27. | [wesm/feather](https://github.com/wesm/feather) <br/>Feather: fast, interoperable binary data frame sto... | 1114 |
| 28. | [openthread/openthread](https://github.com/openthread/openthread) <br/>OpenThread released by Nest is an open-source impl... | 1088 |
| 29. | [Tencent/libco](https://github.com/Tencent/libco) <br/>libco is a coroutine library which is widely used ... | 1043 |
| 30. | [CppCon/CppCon2016](https://github.com/CppCon/CppCon2016) <br/>Slides and other materials from CppCon 2016 | 1015 |
| 31. | [asLody/TurboDex](https://github.com/asLody/TurboDex) <br/>fast load dex in memory. | 1012 |
| 32. | [PixarAnimationStudios/USD](https://github.com/PixarAnimationStudios/USD) <br/>Universal Scene Description | 997 |
| 33. | [ibaaj/dijkstra-cartography](https://github.com/ibaaj/dijkstra-cartography) <br/>Using Dijkstra's algorithm ("finding the shortest ... | 981 |
