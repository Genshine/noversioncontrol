...
| | Repo | Stars |
|---|---|---|
| 1. | [open-power-workgroup/Hospital](https://github.com/open-power-workgroup/Hospital) <br/>OpenPower工作组收集汇总的医院开放数据 | 5308 |
| 2. | [phodal/growth-ebook](https://github.com/phodal/growth-ebook) <br/>Growth Engineering: The Definitive Guide。全栈增长工程师指南 | 4552 |
| 3. | [Microsoft/monaco-editor](https://github.com/Microsoft/monaco-editor) <br/>A browser based code editor | 3499 |
| 4. | [picturepan2/spectre](https://github.com/picturepan2/spectre) <br/>Spectre.css - a lightweight, responsive and modern... | 3177 |
| 5. | [wesbos/JavaScript30](https://github.com/wesbos/JavaScript30) <br/>30 Day Vanilla JS Challenge | 3017 |
| 6. | [jgthms/web-design-in-4-minutes](https://github.com/jgthms/web-design-in-4-minutes) <br/>Learn basics of web design in 4 minutes | 2973 |
| 7. | [viljamis/feature.js](https://github.com/viljamis/feature.js) <br/>Feature.js is a fast, simple and lightweight brows... | 2884 |
| 8. | [jgthms/css-reference](https://github.com/jgthms/css-reference) <br/>CSS Reference: a free visual guide to the most pop... | 2765 |
| 9. | [tawian/text-spinners](https://github.com/tawian/text-spinners) <br/>Pure text, CSS only, font independent, inline load... | 2544 |
| 10. | [elendirx/web2web](https://github.com/elendirx/web2web) <br/>P2P web powered by torrents and blockchain. | 2169 |
| 11. | [phodal/ideabook](https://github.com/phodal/ideabook) <br/>一个全栈增长工程师的练手项目集. A Growth Engineering Idea in Acti... | 1984 |
| 12. | [eladnava/mailgen](https://github.com/eladnava/mailgen) <br/>A Node.js package that generates clean, responsive... | 1909 |
| 13. | [space10-community/conversational-form](https://github.com/space10-community/conversational-form) <br/>Turning web forms into conversations | 1838 |
| 14. | [dirtycow/dirtycow.github.io](https://github.com/dirtycow/dirtycow.github.io) <br/>Dirty COW | 1731 |
| 15. | [secgroundzero/warberry](https://github.com/secgroundzero/warberry) <br/>WarBerryPi - Tactical Exploitation | 1556 |
| 16. | [datasciencebr/serenata-de-amor](https://github.com/datasciencebr/serenata-de-amor) <br/>🕵 Fighting corruption with data and SCIENCE! | 1464 |
| 17. | [ManrajGrover/SingleDivProject](https://github.com/ManrajGrover/SingleDivProject) <br/>One div. Many possibilities. | 1405 |
| 18. | [primefaces/primeng](https://github.com/primefaces/primeng) <br/>UI Components for Angular 2 | 1319 |
| 19. | [BoxFactura/pulltorefresh.js](https://github.com/BoxFactura/pulltorefresh.js) <br/>A quick and powerful plugin for your pull-to-refre... | 1274 |
| 20. | [gavindinubilo/jam-api](https://github.com/gavindinubilo/jam-api) <br/>Parse web pages using CSS query selectors | 1261 |
| 21. | [dxa4481/Pastejacking](https://github.com/dxa4481/Pastejacking) <br/>A demo of overriding what's in a person's clipboar... | 1211 |
| 22. | [phodal/growth-in-action](https://github.com/phodal/growth-in-action) <br/>全栈增长工程师实战 | 1147 |
| 23. | [mjavascript/practical-es6](https://github.com/mjavascript/practical-es6) <br/>🏊 A practical dive into ES6 and maintainable JavaS... | 1137 |
| 24. | [mrholek/CoreUI-Free-Bootstrap-Admin-Template](https://github.com/mrholek/CoreUI-Free-Bootstrap-Admin-Template) <br/>CoreUI is free bootstrap admin template. | 1031 |
| 25. | [codrops/SeatPreview](https://github.com/codrops/SeatPreview) <br/>An experimental demo where a 3D perspective previe... | 890 |
| 26. | [w3c/html](https://github.com/w3c/html) <br/>Working Draft of the HTML specification | 850 |
| 27. | [rigtorp/awesome-modern-cpp](https://github.com/rigtorp/awesome-modern-cpp) <br/>A collection of resources on modern C++ | 837 |
| 28. | [dixonandmoe/rellax](https://github.com/dixonandmoe/rellax) <br/>Lightweight, vanilla javascript parallax library | 793 |
| 29. | [pawelgrzybek/siema](https://github.com/pawelgrzybek/siema) <br/>Siema - Lightweight and simple carousel in pure Ja... | 745 |
| 30. | [d3viant0ne/awesome-webpack](https://github.com/d3viant0ne/awesome-webpack) <br/>A curated list of awesome Webpack resources, libra... | 734 |
| 31. | [stone0090/javascript-lessons](https://github.com/stone0090/javascript-lessons) <br/>本课程之所以叫做《JavaScript 闯关记》，是因为部分章节精心设计了挑战关卡，通过提供更多的实... | 716 |
| 32. | [openai/requests-for-research](https://github.com/openai/requests-for-research) <br/>A living collection of deep learning problems | 715 |
| 33. | [ConsoleTVs/Charts](https://github.com/ConsoleTVs/Charts) <br/>Multi-library chart package to create interactive ... | 714 |
...
| 68. | [samayshamdasani](https://github.com/samayshamdasani)  | [enlight](https://github.com/samayshamdasani/enlight)  (218) <br/> | 218 |
...
| 105. | [potch](https://github.com/potch)  | [unmaintained.tech](https://github.com/potch/unmaintained.tech)  (141) <br/> | 141 |
...
| 140. | [GediminasMasaitis](https://github.com/GediminasMasaitis)  | [PokeEase](https://github.com/GediminasMasaitis/PokeEase)  (109) <br/> | 109 |
...
| 12. | [dixonandmoe](https://github.com/dixonandmoe)  | [rellax](https://github.com/dixonandmoe/rellax)  (793) <br/> | 793 |
...
| 36. | [dollabs](https://github.com/dollabs)  | [pamela](https://github.com/dollabs/pamela)  (240) <br/> | 240 |
...
| 68. | [kubernetes](https://github.com/kubernetes)  | [minikube](https://github.com/kubernetes/minikube)  (2326) <br/>[kops](https://github.com/kubernetes/kops)  (797) <br/>[client-go](https://github.com/kubernetes/client-go)  (153) <br/>[kubernetes.github.io](https://github.com/kubernetes/kubernetes.github.io)  (112) <br/> | 112 |
...
| HTML | [Repos](https://github.com/donnemartin/gh-stats/blob/mas