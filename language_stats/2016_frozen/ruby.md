...
| | Repo | Stars |
|---|---|---|
| 1. | [Homebrew/brew](https://github.com/Homebrew/brew) <br/>:beer: The missing package manager for macOS | 5439 |
| 2. | [roberdam/Xaddress](https://github.com/roberdam/Xaddress) <br/>Xaddress - Give 7 billion people an instant physic... | 1189 |
| 3. | [Homebrew/homebrew-core](https://github.com/Homebrew/homebrew-core) <br/>:beers: Core formulae for the Homebrew package man... | 1165 |
| 4. | [octobox/octobox](https://github.com/octobox/octobox) <br/>:postbox: Take back control of your GitHub Notific... | 1146 |
| 5. | [Gargron/mastodon](https://github.com/Gargron/mastodon) <br/>A GNU Social-compatible microblogging server | 1089 |
| 6. | [iridakos/duckrails](https://github.com/iridakos/duckrails) <br/>A development tool to quickly & dynamically mock A... | 1031 |
| 7. | [segiddins/ThisCouldBeUsButYouPlaying](https://github.com/segiddins/ThisCouldBeUsButYouPlaying) <br/>:black_joker: Generate Swift Playgrounds for any l... | 864 |
| 8. | [willianjusten/awesome-audio-visualization](https://github.com/willianjusten/awesome-audio-visualization) <br/>A curated list about Audio Visualization. | 792 |
| 9. | [testdouble/suture](https://github.com/testdouble/suture) <br/>🏥 A Ruby gem that helps you refactor your legacy c... | 782 |
| 10. | [inket/update_xcode_plugins](https://github.com/inket/update_xcode_plugins) <br/>No more messing with plugin UUIDs; Plugins on Xcod... | 715 |
| 11. | [rails/webpacker](https://github.com/rails/webpacker) <br/>Use Webpack to manage app-like JavaScript modules ... | 643 |
| 12. | [danielpclark/faster_path](https://github.com/danielpclark/faster_path) <br/>Faster Pathname handling for Ruby written in Rust | 636 |
| 13. | [heckpsi-lab/em-midori](https://github.com/heckpsi-lab/em-midori) <br/>Lightweight, Flexible and Fast Ruby Web Framework | 573 |
| 14. | [forward3d/uphold](https://github.com/forward3d/uphold) <br/>A tool for programmatically verifying database bac... | 539 |
| 15. | [rpplusplus/PokemonHook](https://github.com/rpplusplus/PokemonHook)  | 510 |
| 16. | [substrakt/letsencrypt-heroku](https://github.com/substrakt/letsencrypt-heroku) <br/>Make any Heroku application secure in just a coupl... | 504 |
| 17. | [StephenGrider/ReduxCasts](https://github.com/StephenGrider/ReduxCasts) <br/>Modern React with Redux | 490 |
| 18. | [hyperoslo/facebook-messenger](https://github.com/hyperoslo/facebook-messenger) <br/>Definitely the best Ruby client for Bots on Messen... | 462 |
| 19. | [beweinreich/mlooper](https://github.com/beweinreich/mlooper) <br/>The sp@mlooper | 459 |
| 20. | [tsurupin/portfolio](https://github.com/tsurupin/portfolio) <br/>A blog and Portfolio CMS built with Rails, React, ... | 445 |
| 21. | [ankane/pgslice](https://github.com/ankane/pgslice) <br/>Postgres partitioning as easy as pie | 440 |
| 22. | [amatsuda/jb](https://github.com/amatsuda/jb) <br/>A simple and fast JSON API template engine for Rub... | 413 |
| 23. | [adamcooke/procodile](https://github.com/adamcooke/procodile) <br/>🐊 Run Ruby/Rails processes in the background on Li... | 405 |
| 24. | [square/shift](https://github.com/square/shift) <br/>shift is an application that helps you run schema ... | 402 |
| 25. | [EugenMayer/docker-sync](https://github.com/EugenMayer/docker-sync) <br/>Run your application at full speed while syncing y... | 387 |
| 26. | [WhitewidowScanner/whitewidow](https://github.com/WhitewidowScanner/whitewidow) <br/>SQL Vulnerability Scanner | 359 |
| 27. | [arbox/nlp-with-ruby](https://github.com/arbox/nlp-with-ruby) <br/>Practical Natural Language Processing done in Ruby... | 353 |
| 28. | [wojteklu/depcheck](https://github.com/wojteklu/depcheck) <br/>Dependency analyzer tool for Swift projects | 348 |
| 29. | [zendesk/ruby-kafka](https://github.com/zendesk/ruby-kafka) <br/>A Ruby client library for Apache Kafka 0.9 | 347 |
| 30. | [mame/optcarrot](https://github.com/mame/optcarrot) <br/>A NES emulator written in Ruby | 346 |
| 31. | [somaticio/tensorflow.rb](https://github.com/somaticio/tensorflow.rb) <br/>tensorflow for ruby | 340 |
| 32. | [KrauseFx/overkill](https://github.com/KrauseFx/overkill) <br/>Don't let iTunes interrupt your workflow 💥🎵 | 333 |
| 33. | [iridakos/table_flipper](https://github.com/iridakos/table_flipper) <br/>A useless gem for table flipping on exceptions | 303 |
