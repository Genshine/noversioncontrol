...
| | Repo | Stars |
|---|---|---|
| 1. | [Tencent/mars](https://github.com/Tencent/mars) <br/>Mars is a cross-platform network component  develo... | 5840 |
| 2. | [openai/universe](https://github.com/openai/universe) <br/>Universe: a software platform for measuring and tr... | 3852 |
| 3. | [kickstarter/ios-oss](https://github.com/kickstarter/ios-oss) <br/>Kickstarter for iOS. Bring new ideas to life, anyw... | 3634 |
| 4. | [kickstarter/android-oss](https://github.com/kickstarter/android-oss) <br/>Kickstarter for Android. Bring new ideas to life, ... | 3032 |
| 5. | [wesbos/JavaScript30](https://github.com/wesbos/JavaScript30) <br/>30 Day Vanilla JS Challenge | 3025 |
| 6. | [miloyip/game-programmer](https://github.com/miloyip/game-programmer) <br/>A Study Path for Game Programmer | 2692 |
| 7. | [rstacruz/webpack-tricks](https://github.com/rstacruz/webpack-tricks) <br/>Tips and tricks in using Webpack | 1940 |
| 8. | [devongovett/regexgen](https://github.com/devongovett/regexgen) <br/>Generate regular expressions that match a set of s... | 1917 |
| 9. | [keonkim/awesome-bits](https://github.com/keonkim/awesome-bits) <br/>:computer: A curated list of awesome bitwise opera... | 1705 |
| 10. | [pubkey/rxdb](https://github.com/pubkey/rxdb) <br/>Reactive Offline-first Database with Sync, Schema,... | 1663 |
| 11. | [MicheleBertoli/react-fix-it](https://github.com/MicheleBertoli/react-fix-it) <br/>Automagically generate tests from errors | 1568 |
| 12. | [material-components/material-components-web](https://github.com/material-components/material-components-web) <br/>Modular and customizable Material Design UI compon... | 1533 |
| 13. | [material-components/material-components-android](https://github.com/material-components/material-components-android) <br/>Modular and customizable Material Design UI compon... | 1429 |
| 14. | [githubwing/ZoomHeader](https://github.com/githubwing/ZoomHeader) <br/>A demo of animation show how turn viewpager into d... | 1380 |
| 15. | [deepmind/learning-to-learn](https://github.com/deepmind/learning-to-learn) <br/>Learning to Learn in TensorFlow | 1375 |
| 16. | [krzysztofzablocki/Sourcery](https://github.com/krzysztofzablocki/Sourcery) <br/>A tool that brings meta-programming to Swift, allo... | 1302 |
| 17. | [octobox/octobox](https://github.com/octobox/octobox) <br/>:postbox: Take back control of your GitHub Notific... | 1148 |
| 18. | [mathisonian/premonish](https://github.com/mathisonian/premonish) <br/>Predict which DOM element a user will interact wit... | 1126 |
| 19. | [kennethreitz/maya](https://github.com/kennethreitz/maya) <br/>Datetimes for Humans™ | 1058 |
| 20. | [zeit/styled-jsx](https://github.com/zeit/styled-jsx) <br/>Full CSS support for JSX without compromises | 875 |
| 21. | [mancj/SlideUp-Android](https://github.com/mancj/SlideUp-Android) <br/>SlideUp is a small library that allows you to add ... | 842 |
| 22. | [DynamicCocoa/DynamicCocoa](https://github.com/DynamicCocoa/DynamicCocoa) <br/>A framework for running Cocoa code dynamically. | 803 |
| 23. | [Microsoft/HoloJS](https://github.com/Microsoft/HoloJS) <br/>Provides a framework for creating holographic apps... | 800 |
| 24. | [soumith/ganhacks](https://github.com/soumith/ganhacks) <br/>starter from "How to Train a GAN?" at NIPS2016 | 735 |
| 25. | [andywer/leakage](https://github.com/andywer/leakage) <br/>🐛 Memory leak testing for node. | 733 |
| 26. | [race604/WaveLoading](https://github.com/race604/WaveLoading) <br/>A wave-like loading drawable | 733 |
| 27. | [chvin/react-tetris](https://github.com/chvin/react-tetris) <br/>Use React, Redux, Immutable to code Tetris. | 690 |
| 28. | [facebookincubator/react-vr](https://github.com/facebookincubator/react-vr) <br/>Issues-only repo for React VR - a React Native pla... | 690 |
| 29. | [gjiazhe/PanoramaImageView](https://github.com/gjiazhe/PanoramaImageView) <br/>An imageView can auto scroll with device rotating. | 680 |
| 30. | [rails/webpacker](https://github.com/rails/webpacker) <br/>Use Webpack to manage app-like JavaScript modules ... | 644 |
| 31. | [QMUI/QMUI_iOS](https://github.com/QMUI/QMUI_iOS) <br/>QMUI iOS——致力于提高项目 UI 开发效率的解决方案 | 614 |
| 32. | [shaohui10086/ShareUtil](https://github.com/shaohui10086/ShareUtil) <br/>社会化登录分享工具库 | 605 |
| 33. | [oklog/ulid](https://github.com/oklog/ulid) <br/>Universally Unique Lexicographically Sortable Iden... | 600 |
